...
export const ru_RU: EnTranslations = {
  ...
  "editor": {
    ...
    "topbar": {
      ...
      "newFlat": "New Map",
      "newFlatTitle": "Создать пустую плоскую карту выбранного размера",
      "open": "Открыть",
      ...
      "importModel": "Импорт модели",
      "importModelTitle": "Загрузить модель .glb или .gltf с этого компьютера и разместить её, полностью офлайн (хранится в течение сессии)",
      "playtest": "Тест",
      ...
      "more": "More",
      "moreTitle": "Дополнительные действия: сохранить как, автосохранение, форк, импорт/экспорт, загрузка",
      "settings": "Settings",
    ...
    "biome": {
      ...
      "addSwatch": "Add",
      "swatchColor": "Цвет нового образца",
      "swatchNamePlaceholder": "Название образца (необязательно)",
      "customHint": "Пользовательские образцы меняют только цвет земли (форма рельефа остаётся от биома зоны) и сохраняются вместе с картой.",
      "customFull": "Достигнут предел образцов ({max}).",
      "importTexture": "Импорт текстуры-образца",
      "importTextureTitle": "Выберите изображение: покраска новым образцом замостит его по земле (хранится в этом браузере; на других машинах виден средний цвет)",
      "tileSize": "Размер тайла текстуры (ярды)",
      "importTextureFailed": "Не удалось прочитать это изображение.",
      ...
      "bucketTitle": "Arm the bucket, then click the ground: every cell painted with the clicked texture switches to the selected swatch",
      ...
      "pickTexture": "Выберите текстуру для рисования",
      "alphaTitle": "Альфа кисти",
      "alphaNone": "Нет",
      "alphaImport": "Импорт альфы",
      "alphaImportTitle": "Загрузите чёрно-белое изображение как маску кисти: белое красит, чёрное маскирует (хранится в этом браузере)",
      "alphaImportFailed": "Не удалось прочитать это изображение как альфу кисти.",
      "alphaRemove": "Удалить эту импортированную альфу",
      "autoTitle": "Автотекстуры",
      "autoSlopeRock": "Камень на крутых склонах",
      "autoSnowCaps": "Заснеженные вершины",
      "autoRim": "Горы по краю карты",
      "autoShoreSand": "Sand near the water",
      "autoHint": "Правила автоматического текстурирования. Ваша покраска всегда важнее них; снятая галочка убирает правило по всей карте."
    },
    "zoneTool": {
    ...
    "lightTool": {
      ...
      "lightN": "Свет {num}",
      "selectTitle": "Выбрать этот источник света в мире (значок лампочки увеличится; Delete удаляет)"
    },
    "markerTool": {
      "title": "AI Markers",
    ...
    "water": {
      ...
      "waterfallTitle": "Водопады",
      "placeWaterfall": "Разместить водопад",
      "placeWaterfallTitle": "Зарядить инструмент размещения анимированным водопадом (щёлкните по обрыву, чтобы поставить)",
      "waterfallLabel": "Водопад",
      "waterfallHint": "Анимированная стена падающей воды с пенным омутом. Масштабируйте по обрыву клавишей S или гизмо; ручка Y растягивает только высоту."
    },
    "place": {
    ...
    "collider": {
      "title": "Объёмы столкновений",
      "hint": "Выберите форму и щёлкните по земле, чтобы разместить её. Используйте перемещение, поворот и масштаб (или ползунки ниже).",
      "shapeLabel": "Форма коллайдера",
      "box": "Коллайдер-куб",
      "sphere": "Коллайдер-сфера",
      ...
      "depth": "Глубина",
      "diameter": "Диаметр",
      "floorOffset": "Смещение высоты пола",
      "sizeHint": "Размеры указаны в ярдах при масштабе 1; инструмент масштаба умножает их.",
      "playtestNote": "В редакторе объёмы показаны зелёным, в плейтесте невидимы: кубы и сферы блокируют движение, плоскости пола поднимают проходимую поверхность.",
      "hideVolumes": "Hide collision volumes",
      "hideVolumesHint": "Hides the green volume overlays in the viewport (they still block in playtest)."
    },
    "foliageTool": {
      "title": "Кисть растительности",
      "hint": "Проведите по земле, чтобы рассыпать включённую растительность внутри кисти; каждый мазок — один шаг отмены. Удаляйте ластиком.",
      "density": "Плотность",
      "minScale": "Мин. размер",
      "maxScale": "Макс. размер",
      "grass": "Трава и папоротники",
      "grassHue": "Grass hue",
      ...
      "trees": "Деревья",
      "rocks": "Камни",
      "collide": "Новая растительность блокирует движение",
      "noneSelected": "Включите хотя бы одну группу растительности, чтобы рисовать.",
      "customTitle": "Custom brush asset",
      "customHint": "Scatter your own asset instead of the built-in sets. Pick any model from the browser below, then brush as usual.",
    ...
    "selection": {
      ...
      "y": "Y",
      "z": "Z",
      "multiCount": "Выбрано ассетов: {count}",
      "multiHint": "Перемещение, дублирование Shift+D и удаление применяются ко всему выделению; Shift+щелчок добавляет или убирает ассеты.",
      "rotation": "Поворот",
      "scale": "Масштаб",
      "collide": "Блокирует движение",
    ...
    "transform": {
      "moveHint": "Тяните стрелку гизмо для движения по оси или жёлтый квадрат для свободного перемещения. Стрелки клавиатуры дают точную подгонку.",
      "rotateHint": "Тяните кольцо гизмо, чтобы вращать вокруг оси. Shift+прокрутка вращает шагами по 15 градусов.",
      "scaleHint": "Тяните осевой манипулятор, чтобы растянуть ось, или жёлтый центральный куб для равномерного масштаба.",
      "pickHint": "Щёлкните по ассету, чтобы выбрать его; на выделении появится гизмо."
    },
    "marker": {
      "title": "Маркер",
    ...
    "assets": {
      ...
      "importedTab": "Импортированные",
      "importedEmpty": "В этой сессии нет импортированных моделей. Используйте «Импорт модели», чтобы загрузить .glb или .gltf.",
      "removeImported": "Удалить импортированную модель (только эта сессия)",
      ...
      "resizeHandle": "Перетащите, чтобы изменить высоту браузера ассетов",
      "category": {
        "biome": "Биомы",
        "chars": "Персонажи",
        "creatures": "Существа",
    ...
    "importModel": {
      "notModel": "Выберите файл .glb или .gltf.",
      "tooLarge": "Файл превышает лимит импорта 64 МиБ.",
      "imported": "Импортировано «{name}». Хранится в течение сессии; после перезагрузки импортируйте заново.",
      "failed": "Не удалось прочитать файл модели."
    },
    "upload": {
    ...
    "status": {
      ...
      "newFlatMap": "Создана пустая карта.",
    ...
    "newMap": {
      "title": "New Map",
      "hint": "Выберите пресет или задайте размер в ярдах. Карта ограничена: гребни рельефа и невидимые стены по периметру удерживают плейтест внутри.",
      "width": "Ширина (ярды)",
      "height": "Высота (ярды)",
      "scale": "Множитель масштаба",
      "interior": "Интерьер (60 x 60)",
      "zone": "Zone (240 x 360)",
      "openWorld": "Открытый мир (400 x 800)",
      "create": "Создать"
    },
    "serverError": {
    ...
    "lighting": {
      "title": "Освещение",
      "presetLabel": "Пресет освещения",
      "day": "Day",
      "overcast": "Пасмурно",
      "dusk": "Dusk",
      "night": "Ночь",
      "customHint": "Пользовательское освещение (изменено из пресета).",
      "sun": "Интенсивность солнца",
      "ambient": "Интенсивность рассеянного света",
      "environment": "Свечение неба",
      "azimuth": "Направление солнца",
      "elevation": "Высота солнца",
      "sunColor": "Цвет солнца",
      "skyColor": "Оттенок неба",
      "hint": "Только предпросмотр в редакторе: в плейтесте остаётся стандартное игровое освещение.",
      "skyboxTitle": "Skybox",
      "skyboxDefault": "Default sky",
      "skybox_toon_day": "Toon Blue Sky",
      "skyboxUpload": "Upload skybox...",
      "skyboxCustomActive": "Custom skybox active.",
      "skyboxHint": "Pick a bundled sky or upload a panoramic (equirectangular) image. Saved with the map - playtest shows it in-game.",
      ...
      "worldSpeedHint": "Speeds up or slows every ambient motion (water, fire, foliage sway, birds, weather). Cosmetic only; it never changes playtest gameplay or timing.",
      "worldSpeedReset": "Reset to normal speed"
    },
    "music": {
      "title": "Музыка",
      "hint": "Выберите саундтрек для всей карты или растяните рамки, чтобы дать областям свои треки. В плейтесте музыка сменится на границе.",
      "zoneTrack": "Трек карты",
      "default": "Авто (тема биома)",
      "areasTitle": "Музыкальные области",
      "areaTrack": "Трек для новых областей",
      "rowTrack": "Трек этой области",
      "dragHint": "Растяните рамку по земле, чтобы добавить область с выбранным выше треком. Щелчок по области выбирает её (Delete удаляет). При пересечении побеждает меньшая область.",
      "none": "Музыкальных областей пока нет.",
      "areaN": "Область {num}",
      "selectArea": "Выбрать эту область в мире (рамка подсветится; Delete удаляет)",
      "removeArea": "Удалить эту музыкальную область",
      "areaCap": "Достигнут предел музыкальных областей ({max}).",
      "track": {
        "town_eastbrook": "Город: Истбрук (тёплая пастораль)",
        "town_fenbridge": "Город: Фенбридж (старое средневековье)",
        "town_highwatch": "Город: Хайвотч (бодрый марш)",
        "vale": "Долина (игривый луг)",
        "vale_legacy": "Долина, классика (оригинальная тема)",
        "marsh": "Болото (квакающая топь)",
        "peaks": "Пики (героический фолк)",
        "dungeon_hollow_crypt": "Подземелье: Полая крипта (танец скелетов)",
        "dungeon_sunken_bastion": "Подземелье: Затонувший бастион (залитая крепость)",
        "dungeon_gravewyrm_sanctum": "Подземелье: Святилище Могильного змея (путь к боссу)"
      }
    },
    "weather": {
      "title": "Погода",
      ...
      "rain": "Дождь",
      "snow": "Снег",
      "sparkle": "Золотые искры",
      "intensity": "Интенсивность",
      "cloudCover": "Облачность",
      "cloudHeight": "Высота облаков (ярды)",
      "cloudHint": "Низкие облака стелются по рельефу и выглядят как наземный туман.",
      "scheduleTitle": "Динамическая погода",
      "scheduleWins": "Расписание работает: оно важнее фиксированной погоды выше.",
      "stepMode": "Погода на этом шаге",
      "stepMinutes": "Длительность шага в минутах",
      "minutesShort": "мин",
      "removeStep": "Удалить этот шаг",
      "addStep": "Добавить шаг",
      "addStepTitle": "Шаги идут по кругу в заданном порядке, каждый длится свои минуты, затем цикл повторяется",
      "scheduleHint": "Шаги повторяются по порядку (дождь 5 мин, затем ясно 10 мин, ...). Сохраняется с картой и работает в плейтесте."
    },
    "camera": {
      "title": "Камера",
      "focus": "Фокус на выделении (.)",
      "focusTitle": "Переносит центр орбиты на выбранный объект, чтобы камера вращалась вокруг него; без выделения кадрирует всю карту",
      "freeFly": "Свободный полёт (Shift+F)",
      "freeFlyHint": "WASD — движение, Q/E — вверх/вниз, перетаскивание — обзор от первого лица.",
      "invertPan": "Инвертировать панорамирование",
      "showBoundary": "Show map boundary walls",
      "showPlayer": "Показывать персонажа плейтеста",
      ...
      "assetViewHint": "How far placed decor renders before it fades out and stops drawing, to save performance. Lower it to cull distant assets sooner; raise it to see farther. Saved with the map, so playtest matches."
    },
    "hints": {
    ...
    "help": {
      ...
      "tool": {
        ...
        "move": "Перемещайте выбранный ассет стрелками трёхосевого гизмо.",
        "rotate": "Вращайте выбранный ассет кольцами гизмо.",
        "scale": "Масштабируйте выбранный ассет по осям или равномерно с помощью гизмо.",
        ...
        "foliage": "Рисуйте кистью траву, кусты, деревья и камни с вариацией размера.",
        "blocker": "Рисует невидимые стены, которые блокируют движение в тестовой игре.",
        "collider": "Размещайте кубы, сферы и плоскости пола: объёмы столкновений, невидимые в плейтесте.",
      ...
      "key": {
        ...
        "multiSelect": "Shift+щелчок добавляет или убирает ассеты из выделения (в стиле Blender).",
