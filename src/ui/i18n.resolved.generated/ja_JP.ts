...
export const ja_JP: EnTranslations = {
  ...
  "editor": {
    ...
    "topbar": {
      ...
      "newFlat": "New Map",
      "newFlatTitle": "サイズを選べる空白のフラットマップを新規作成",
      "open": "開く",
      ...
      "importModelTitle": "この端末から .glb / .gltf モデルを読み込んで配置（完全オフライン、セッション中保持）",
      "playtest": "プレイテスト",
      ...
      "more": "More",
      "moreTitle": "その他の操作：名前を付けて保存・自動保存・フォーク・インポート/エクスポート・アップロード",
      "settings": "Settings",
    ...
    "biome": {
      ...
      "addSwatch": "Add",
      "swatchColor": "新しいスウォッチの色",
      "swatchNamePlaceholder": "スウォッチ名（任意）",
      "customHint": "カスタムスウォッチは地面の色のみを変更し（地形形状はゾーンのバイオームのまま）、マップと共に保存されます。",
      "customFull": "スウォッチの上限（{max}）に達しました。",
      "importTexture": "テクスチャスウォッチを読み込む",
      "importTextureTitle": "画像を選ぶと、新しいスウォッチでのペイント時に地面へタイル状に敷き詰められます（このブラウザに保存され、他の端末では平均色が表示されます）",
      "tileSize": "テクスチャのタイルサイズ（ヤード）",
      "importTextureFailed": "その画像を読み込めませんでした。",
      "clear": "バイオーム塗りをすべて消去",
      ...
      "pickTexture": "ペイントするテクスチャを選択",
      "alphaTitle": "ブラシアルファ",
      "alphaNone": "なし",
      "alphaImport": "アルファを読み込む",
      "alphaImportTitle": "グレースケール画像をブラシマスクとして読み込みます：白は塗り、黒はマスク（このブラウザーに保存）",
      "alphaImportFailed": "その画像をブラシアルファとして読み込めませんでした。",
      "alphaRemove": "この読み込んだアルファを削除",
      "autoTitle": "自動テクスチャ",
      "autoSlopeRock": "急斜面の岩肌",
      "autoSnowCaps": "冠雪した山頂",
      "autoRim": "マップ端の山並み",
      "autoShoreSand": "Sand near the water",
      "autoHint": "自動テクスチャのルールです。ペイントが常に優先され、チェックを外すとマップ全体からそのルールが外れます。"
    },
    "zoneTool": {
    ...
    "lightTool": {
      ...
      "lightN": "ライト {num}",
      "selectTitle": "ワールド内でこのライトを選択（電球バッジが拡大。Delete で削除）"
    },
    "markerTool": {
      "title": "AI Markers",
    ...
    "water": {
      ...
      "waterfallTitle": "滝",
      "placeWaterfall": "滝を配置",
      "placeWaterfallTitle": "配置ツールにアニメーション付きの滝をセットします（崖をクリックで設置）",
      "waterfallLabel": "滝",
      "waterfallHint": "泡立つ滝つぼ付きのアニメーション水幕です。S かギズモで崖に合わせて拡大し、Y スケールで高さだけ伸ばせます。"
    },
    "place": {
      "title": "アセット配置",
      "scale": "スケール",
    ...
    "collider": {
      "title": "コリジョンボリューム",
      "hint": "形状を選んで地面をクリックすると配置されます。移動・回転・スケール（または下のスライダー）で形を整えます。",
      "shapeLabel": "コライダーの形状",
      "box": "ボックスコライダー",
      "sphere": "スフィアコライダー",
      "plane": "床プレーン",
      ...
      "depth": "奥行き",
      "diameter": "直径",
      "floorOffset": "床の高さオフセット",
      "sizeHint": "寸法はスケール1のヤード値です。スケールツールで倍率がかかります。",
      "playtestNote": "ボリュームはエディタでは緑で表示され、プレイテストでは非表示です。ボックスとスフィアは移動を妨げ、床プレーンは歩行面を持ち上げます。",
    ...
    "foliageTool": {
      "title": "植生ブラシ",
      "hint": "地面をドラッグするとブラシ範囲内に有効な植生が散布されます。1ストロークが1回のアンドゥです。個別の削除は消しゴムで。",
      "density": "密度",
      "minScale": "最小サイズ",
      "maxScale": "最大サイズ",
      "grass": "草とシダ",
      ...
      "trees": "木",
      "rocks": "岩",
      "collide": "新しい植生が移動を妨げる",
      "noneSelected": "ペイントするには少なくとも1つの植生グループを有効にしてください。",
    ...
    "selection": {
      ...
      "y": "Y",
      "z": "Z",
      "multiCount": "{count} 個のアセットを選択中",
      "multiHint": "移動・Shift+D 複製・削除は選択全体に適用されます。Shift+クリックでアセットを追加/除外します。",
      "rotation": "回転",
      "scale": "スケール",
      "collide": "移動をブロック",
      "radius": "衝突半径",
    ...
    "transform": {
      "moveHint": "ギズモの矢印でその軸に沿って移動、黄色い四角で自由移動。矢印キーで微調整。",
      "rotateHint": "ギズモのリングをドラッグしてその軸で回転。Shift+スクロールで15度刻みの回転も可能。",
      "scaleHint": "軸ハンドルをドラッグでその軸を伸縮、中央の黄色いキューブで均等スケール。",
      "pickHint": "アセットをクリックすると選択され、ギズモが表示されます。"
    },
    "marker": {
      "title": "マーカー",
      "reset": "位置をリセット",
    ...
    "assets": {
      ...
      "importedTab": "インポート済み",
      "importedEmpty": "このセッションで読み込んだモデルはありません。「モデルを読み込む」で .glb / .gltf を読み込めます。",
      "removeImported": "インポートしたモデルを削除（このセッションのみ）",
      ...
      "resizeHandle": "ドラッグでアセットブラウザーの高さを調整",
      "category": {
        "biome": "バイオーム",
        "chars": "キャラクター",
        "creatures": "クリーチャー",
    ...
    "importModel": {
      "notModel": ".glb または .gltf ファイルを選んでください。",
      "tooLarge": "そのファイルは 64 MiB のインポート上限を超えています。",
      "imported": "「{name}」を読み込みました。このセッション中のみ保持され、リロード後は再読み込みが必要です。",
      "failed": "そのモデルファイルを読み込めませんでした。"
    },
    "upload": {
    ...
    "newMap": {
      "title": "New Map",
      "hint": "プリセットを選ぶかヤード単位でサイズを指定します。マップには境界があり、地形の縁と不可視の外周ブロッカーがプレイテストを内側に留めます。",
      "width": "幅（ヤード）",
      "height": "高さ（ヤード）",
      "scale": "スケール倍率",
      "interior": "屋内（60 x 60）",
      "zone": "Zone (240 x 360)",
      "openWorld": "オープンワールド（400 x 800）",
      "create": "作成"
    },
    "serverError": {
    ...
    "lighting": {
      "title": "ライティング",
      "presetLabel": "ライティングプリセット",
      "day": "Day",
      "overcast": "曇り",
      "dusk": "Dusk",
      "night": "夜",
      "customHint": "カスタムライティング（プリセットから編集）。",
      "sun": "太陽光の強さ",
      "ambient": "環境光の強さ",
      "environment": "空の環境光",
      "azimuth": "太陽の方角",
      ...
      "sunColor": "太陽光の色",
      "skyColor": "空の色合い",
      "hint": "エディタのプレビュー専用：プレイテストは標準のゲームライティングのままです。",
      "skyboxTitle": "Skybox",
    ...
    "music": {
      "title": "ミュージック",
      "hint": "マップ全体のサウンドトラックを選ぶか、ボックスをドラッグしてエリアごとの曲を設定します。プレイテストでは境界を越えると切り替わります。",
      "zoneTrack": "マップの曲",
      "default": "自動（バイオームのテーマ）",
      "areasTitle": "ミュージックエリア",
      "areaTrack": "新しいエリアの曲",
      "rowTrack": "このエリアの曲",
      "dragHint": "地面にボックスをドラッグすると上の曲を使うエリアが追加されます。エリアをクリックすると選択できます（Delete で削除）。重なった場合は小さいエリアが優先。",
      "none": "ミュージックエリアはまだありません。",
      "areaN": "エリア {num}",
      "selectArea": "ワールド内でこのエリアを選択（ボックスがハイライト。Delete で削除）",
      "removeArea": "このミュージックエリアを削除",
      "areaCap": "ミュージックエリアの上限に達しました（{max}）。",
      "track": {
        "town_eastbrook": "町：イーストブルック（暖かな田園）",
        "town_fenbridge": "町：フェンブリッジ（古風な中世）",
        "town_highwatch": "町：ハイウォッチ（軽快な行進曲）",
        "vale": "渓谷（陽気な草原）",
        "vale_legacy": "渓谷レガシー（オリジナルテーマ）",
        "marsh": "湿地（蛙鳴く沼）",
        "peaks": "山峰（勇壮なフォーク）",
        "dungeon_hollow_crypt": "ダンジョン：虚ろの地下聖堂（骸骨の舞）",
        "dungeon_sunken_bastion": "ダンジョン：沈んだ砦（水没要塞）",
        "dungeon_gravewyrm_sanctum": "ダンジョン：墓竜の聖域（ボスへの道）"
      }
    },
    "weather": {
      "title": "天候",
      ...
      "intensity": "強さ",
      "cloudCover": "雲量",
      "cloudHeight": "雲の高さ（ヤード）",
      "cloudHint": "低い雲は地形に沿って流れる地表の霧として見えます。",
      "scheduleTitle": "ダイナミック天候",
      "scheduleWins": "スケジュール実行中：上の固定天候より優先されます。",
      "stepMode": "このステップの天候",
      "stepMinutes": "このステップの継続分数",
      "minutesShort": "分",
      "removeStep": "このステップを削除",
      "addStep": "ステップを追加",
      "addStepTitle": "ステップを順番に繰り返します。各ステップは設定した分数だけ続きます",
      "scheduleHint": "ステップは順番にループします（雨 5 分、晴れ 10 分、...）。マップと一緒に保存され、プレイテストでも動きます。"
    },
    "camera": {
      "title": "カメラ",
      "focus": "選択にフォーカス（.）",
      "focusTitle": "軌道の中心を選択オブジェクトに移し、カメラがその周りを回るようにします。未選択時はマップ全体をフレーミング",
      "freeFly": "フリーフライト（Shift+F）",
      "freeFlyHint": "WASD で移動、Q/E で上下、ドラッグで一人称視点のように見回します。",
      "invertPan": "パン反転",
      "showBoundary": "Show map boundary walls",
      "showPlayer": "プレイテスト用プレイヤーを表示",
    ...
    "help": {
      ...
      "tool": {
        ...
        "move": "3軸ギズモの矢印で選択アセットを移動します。",
        "rotate": "ギズモのリングで選択アセットを回転します。",
        "scale": "ギズモのハンドルで軸ごと、または均等にスケールします。",
        ...
        "foliage": "サイズのばらつき付きで草・低木・木・岩をブラシペイントします。",
        "blocker": "プレイテストで移動を妨げる見えない壁をドラッグで描きます。",
        "collider": "ボックス・スフィア・床プレーンのコリジョンを配置します。プレイテストでは非表示。",
      ...
      "key": {
        ...
        "multiSelect": "Shift+クリックでアセットを選択に追加/除外します（Blender流）。",
