...
export const zh_CN: EnTranslations = {
  ...
  "editor": {
    ...
    "topbar": {
      ...
      "importModel": "导入模型",
      "importModelTitle": "从本机加载 .glb 或 .gltf 模型并放置，完全离线（保留在本会话中）",
      "playtest": "试玩",
      ...
      "more": "More",
      "moreTitle": "更多操作：另存为、自动保存、派生、导入/导出、上传",
      "settings": "Settings",
    ...
    "biome": {
      ...
      "addSwatch": "Add",
      "swatchColor": "新色板颜色",
      "swatchNamePlaceholder": "色板名称（可选）",
      "customHint": "自定义色板只改变地面颜色（地形形状保持区域生态群系），并随地图一起保存。",
      "customFull": "已达到色板上限（{max}）。",
      "importTexture": "导入纹理色板",
      "importTextureTitle": "选择一张图片：用新色板绘制时会将它平铺在地面上（保存在此浏览器中；其他机器显示其平均颜色）",
      "tileSize": "纹理平铺尺寸（码）",
      "importTextureFailed": "无法读取该图片。",
      "clear": "清除全部生态绘制",
      ...
      "pickTexture": "选择要绘制的纹理",
      "alphaTitle": "笔刷 Alpha",
      "alphaNone": "无",
      "alphaImport": "导入 Alpha",
      "alphaImportTitle": "加载灰度图片作为笔刷遮罩：白色绘制，黑色遮挡（保存在此浏览器中）",
      "alphaImportFailed": "无法将该图片读取为笔刷 Alpha。",
      "alphaRemove": "移除此导入的 Alpha",
      "autoTitle": "自动纹理",
      "autoSlopeRock": "陡坡岩石",
      "autoSnowCaps": "雪顶山峰",
      "autoRim": "地图边缘山脉",
      "autoShoreSand": "Sand near the water",
      "autoHint": "自动纹理规则。你的绘制始终优先于它们，取消勾选即在全图移除该规则。"
    },
    "zoneTool": {
    ...
    "lightTool": {
      ...
      "lightN": "灯光 {num}",
      "selectTitle": "在世界中选中此灯光（灯泡图标会放大；按 Delete 删除）"
    },
    "markerTool": {
      "title": "AI Markers",
    ...
    "water": {
      ...
      "waterfallTitle": "瀑布",
      "placeWaterfall": "放置瀑布",
      "placeWaterfallTitle": "用动态瀑布装配放置工具（点击悬崖即可放下）",
      "waterfallLabel": "瀑布",
      "waterfallHint": "带泡沫水潭的动态落水幕。用 S 或坐标器沿悬崖放大；用 Y 缩放手柄只拉伸高度。"
    },
    "place": {
      "title": "放置资源",
      "scale": "缩放",
    ...
    "collider": {
      "title": "碰撞体积",
      "hint": "选择形状后点击地面放置。使用移动、旋转和缩放（或下方滑块）来调整它。",
      "shapeLabel": "碰撞体形状",
      "box": "盒形碰撞体",
      "sphere": "球形碰撞体",
      "plane": "地板平面",
      ...
      "diameter": "直径",
      "floorOffset": "地板高度偏移",
      "sizeHint": "尺寸为缩放 1 时的码数；缩放工具会按倍数放大。",
      "playtestNote": "体积在编辑器中显示为绿色，试玩时不可见：盒体和球体阻挡移动，地板平面抬高可行走地面。",
    ...
    "foliageTool": {
      "title": "植被笔刷",
      "hint": "在地面上拖动即可在笔刷范围内散布启用的植被；每次笔画为一步撤销。用擦除移除单株。",
      "density": "密度",
      "minScale": "最小尺寸",
      "maxScale": "最大尺寸",
      "grass": "草与蕨类",
    ...
    "selection": {
      ...
      "y": "Y",
      "z": "Z",
      "multiCount": "已选中 {count} 个资产",
      "multiHint": "移动、Shift+D 复制和删除会作用于整个选择集；Shift+点击可增删资产。",
      "rotation": "旋转",
      "scale": "缩放",
      "collide": "阻挡移动",
      "radius": "碰撞半径",
    ...
    "transform": {
      "moveHint": "拖动坐标轴箭头沿该轴移动，或拖动黄色方块自由移动。方向键微调。",
      "rotateHint": "拖动坐标环绕该轴旋转。Shift+滚轮以 15 度步进旋转。",
      "scaleHint": "拖动轴向手柄拉伸该轴，或拖动黄色中心立方体整体缩放。",
      "pickHint": "点击资产以选中；坐标器会出现在选中项上。"
    },
    "marker": {
      "title": "标记",
      "reset": "重置位置",
    ...
    "assets": {
      ...
      "uploadedTab": "已上传",
      "importedTab": "已导入",
      "importedEmpty": "本会话尚未导入模型。使用「导入模型」从本机加载 .glb 或 .gltf。",
      "removeImported": "移除已导入的模型（仅本会话）",
    ...
    "importModel": {
      "notModel": "请选择 .glb 或 .gltf 文件。",
      "tooLarge": "该文件超过 64 MiB 导入上限。",
      "imported": "已导入「{name}」。仅保留在本会话中；刷新后需重新导入。",
      "failed": "无法读取该模型文件。"
    },
    "upload": {
      "notGlb": "请选择一个 .glb 文件。",
    ...
    "newMap": {
      "title": "New Map",
      "hint": "选择预设或按码数设置尺寸。地图有边界：地形山脊和隐形边界墙会把试玩限制在内部。",
      "width": "宽度（码）",
      "height": "高度（码）",
      "scale": "缩放倍数",
      "interior": "室内（60 x 60）",
      "zone": "Zone (240 x 360)",
      "openWorld": "开放世界（400 x 800）",
      "create": "创建"
    },
    "serverError": {
    ...
    "music": {
      "title": "音乐",
      "hint": "为整张地图选择配乐，或拖出方框让区域拥有自己的曲目。试玩时跨越边界会切换。",
      "zoneTrack": "地图曲目",
      "default": "自动（生态主题）",
      "areasTitle": "音乐区域",
      "areaTrack": "新区域的曲目",
      "rowTrack": "此区域的曲目",
      "dragHint": "在地面拖出方框即可添加使用上方曲目的区域。点击区域可选中它（Delete 删除）。重叠处较小的区域优先。",
      "none": "还没有音乐区域。",
      "areaN": "区域 {num}",
      "selectArea": "在世界中选中此区域（方框会高亮；按 Delete 删除）",
      "removeArea": "移除此音乐区域",
      "areaCap": "音乐区域已达上限（{max}）。",
      "track": {
        "town_eastbrook": "城镇：东溪（温暖田园）",
        "town_fenbridge": "城镇：芬桥（古典中世纪）",
        "town_highwatch": "城镇：高望（轻快进行曲）",
        "vale": "溪谷（欢快草甸）",
        "vale_legacy": "溪谷怀旧（原版主题）",
        "marsh": "沼泽（蛙鸣湿地）",
        "peaks": "山峰（英雄民谣）",
        "dungeon_hollow_crypt": "地下城：空幽墓穴（骸骨之舞）",
        "dungeon_sunken_bastion": "地下城：沉没堡垒（水淹要塞）",
        "dungeon_gravewyrm_sanctum": "地下城：墓龙圣殿（首领之路）"
      }
    },
    "weather": {
      "title": "天气",
      ...
      "cloudCover": "云量",
      "cloudHeight": "云层高度（码）",
      "cloudHint": "低空云会贴着地形，呈现为滚动的地面雾。",
      "scheduleTitle": "动态天气",
      "scheduleWins": "计划正在运行：它会覆盖上面的固定天气。",
      "stepMode": "此阶段的天气",
      "stepMinutes": "此阶段持续的分钟数",
      "minutesShort": "分钟",
      "removeStep": "移除此阶段",
      "addStep": "添加阶段",
      "addStepTitle": "按顺序循环各阶段，每个阶段持续其设定的分钟数，然后重复",
      "scheduleHint": "阶段按顺序循环（雨 5 分钟，然后晴 10 分钟，...）。随地图保存并在试玩中运行。"
    },
    "camera": {
      "title": "相机",
      "focus": "聚焦选中项（.）",
      "focusTitle": "把环绕轴心移到选中物体上，使相机围绕它旋转；未选中时框选整张地图",
      "freeFly": "自由飞行（Shift+F）",
      "freeFlyHint": "WASD 移动，Q/E 升降，拖动如第一人称环视。",
      "invertPan": "反转平移",
    ...
    "help": {
      ...
      "tool": {
        ...
        "move": "用三轴坐标器箭头移动选中的资产。",
        "rotate": "用坐标环旋转选中的资产。",
        "scale": "用坐标手柄按轴或整体缩放选中的资产。",
        "raise": "抬高笔刷下方的地形。",
        "lower": "降低笔刷下方的地形。",
        "smooth": "将起伏平滑到局部平均高度。",
        ...
        "foliage": "以可变尺寸笔刷绘制草、灌木、树木和岩石。",
        "blocker": "拖动绘制在试玩中阻挡移动的隐形墙。",
        "collider": "放置盒形、球形或地板平面碰撞体积，试玩时不可见。",
      ...
      "key": {
        ...
        "multiSelect": "Shift+点击可将资产加入或移出选择集（Blender 风格）。",
