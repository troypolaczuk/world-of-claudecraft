...
export const zh_TW: EnTranslations = {
  ...
  "editor": {
    ...
    "topbar": {
      ...
      "importModel": "匯入模型",
      "importModelTitle": "從本機載入 .glb 或 .gltf 模型並放置，完全離線（保留於本工作階段）",
      "playtest": "試玩",
      ...
      "more": "More",
      "moreTitle": "更多操作：另存為、自動儲存、分支、匯入/匯出、上傳",
      "settings": "Settings",
    ...
    "biome": {
      ...
      "addSwatch": "Add",
      "swatchColor": "新色板顏色",
      "swatchNamePlaceholder": "色板名稱（可選）",
      "customHint": "自訂色板只改變地面顏色（地形形狀維持區域生態群系），並隨地圖一起儲存。",
      "customFull": "已達到色板上限（{max}）。",
      "importTexture": "匯入紋理色板",
      "importTextureTitle": "選擇一張圖片：用新色板繪製時會將它平鋪在地面上（保存於此瀏覽器；其他機器顯示其平均顏色）",
      "tileSize": "紋理平鋪尺寸（碼）",
      "importTextureFailed": "無法讀取該圖片。",
      "clear": "清除全部生態繪製",
      ...
      "pickTexture": "選擇要繪製的紋理",
      "alphaTitle": "筆刷 Alpha",
      "alphaNone": "無",
      "alphaImport": "匯入 Alpha",
      "alphaImportTitle": "載入灰階圖片作為筆刷遮罩：白色繪製，黑色遮擋（保存在此瀏覽器中）",
      "alphaImportFailed": "無法將該圖片讀取為筆刷 Alpha。",
      "alphaRemove": "移除此匯入的 Alpha",
      "autoTitle": "自動紋理",
      "autoSlopeRock": "陡坡岩石",
      "autoSnowCaps": "雪頂山峰",
      "autoRim": "地圖邊緣山脈",
      "autoShoreSand": "Sand near the water",
      "autoHint": "自動紋理規則。你的繪製始終優先於它們，取消勾選即在全圖移除該規則。"
    },
    "zoneTool": {
    ...
    "lightTool": {
      ...
      "lightN": "燈光 {num}",
      "selectTitle": "在世界中選取此燈光（燈泡圖示會放大；按 Delete 刪除）"
    },
    "markerTool": {
      "title": "AI Markers",
    ...
    "water": {
      ...
      "waterfallTitle": "瀑布",
      "placeWaterfall": "放置瀑布",
      "placeWaterfallTitle": "用動態瀑布裝配放置工具（點擊懸崖即可放下）",
      "waterfallLabel": "瀑布",
      "waterfallHint": "帶泡沫水潭的動態落水幕。用 S 或座標器沿懸崖放大；用 Y 縮放手柄只拉伸高度。"
    },
    "place": {
      "title": "放置資源",
      "scale": "縮放",
    ...
    "collider": {
      "title": "碰撞體積",
      "hint": "選擇形狀後點擊地面放置。使用移動、旋轉和縮放（或下方滑桿）來調整它。",
      "shapeLabel": "碰撞體形狀",
      "box": "盒形碰撞體",
      "sphere": "球形碰撞體",
      "plane": "地板平面",
      ...
      "diameter": "直徑",
      "floorOffset": "地板高度偏移",
      "sizeHint": "尺寸為縮放 1 時的碼數；縮放工具會按倍數放大。",
      "playtestNote": "體積在編輯器中顯示為綠色，試玩時不可見：盒體和球體阻擋移動，地板平面抬高可行走地面。",
    ...
    "foliageTool": {
      "title": "植被筆刷",
      "hint": "在地面上拖動即可在筆刷範圍內散布啟用的植被；每次筆畫為一步復原。用擦除移除單株。",
      "density": "密度",
      "minScale": "最小尺寸",
      "maxScale": "最大尺寸",
      "grass": "草與蕨類",
    ...
    "selection": {
      ...
      "y": "Y",
      "z": "Z",
      "multiCount": "已選取 {count} 個資產",
      "multiHint": "移動、Shift+D 複製和刪除會作用於整個選取集；Shift+點擊可增刪資產。",
      "rotation": "旋轉",
      "scale": "縮放",
      "collide": "阻擋移動",
      "radius": "碰撞半徑",
    ...
    "transform": {
      "moveHint": "拖動座標軸箭頭沿該軸移動，或拖動黃色方塊自由移動。方向鍵微調。",
      "rotateHint": "拖動座標環繞該軸旋轉。Shift+滾輪以 15 度步進旋轉。",
      "scaleHint": "拖動軸向手柄拉伸該軸，或拖動黃色中心立方體整體縮放。",
      "pickHint": "點擊資產以選取；座標器會出現在選取項上。"
    },
    "marker": {
      "title": "標記",
      "reset": "重設位置",
    ...
    "assets": {
      ...
      "uploadedTab": "已上傳",
      "importedTab": "已匯入",
      "importedEmpty": "本工作階段尚未匯入模型。使用「匯入模型」從本機載入 .glb 或 .gltf。",
      "removeImported": "移除已匯入的模型（僅本工作階段）",
    ...
    "importModel": {
      "notModel": "請選擇 .glb 或 .gltf 檔案。",
      "tooLarge": "該檔案超過 64 MiB 匯入上限。",
      "imported": "已匯入「{name}」。僅保留於本工作階段；重新整理後需重新匯入。",
      "failed": "無法讀取該模型檔案。"
    },
    "upload": {
      "notGlb": "請選擇一個 .glb 檔案。",
    ...
    "newMap": {
      "title": "New Map",
      "hint": "選擇預設或按碼數設定尺寸。地圖有邊界：地形山脊和隱形邊界牆會把試玩限制在內部。",
      "width": "寬度（碼）",
      "height": "高度（碼）",
      "scale": "縮放倍數",
      "interior": "室內（60 x 60）",
      "zone": "Zone (240 x 360)",
      "openWorld": "開放世界（400 x 800）",
      "create": "建立"
    },
    "serverError": {
    ...
    "music": {
      "title": "音樂",
      "hint": "為整張地圖選擇配樂，或拖出方框讓區域擁有自己的曲目。試玩時跨越邊界會切換。",
      "zoneTrack": "地圖曲目",
      "default": "自動（生態主題）",
      "areasTitle": "音樂區域",
      "areaTrack": "新區域的曲目",
      "rowTrack": "此區域的曲目",
      "dragHint": "在地面拖出方框即可新增使用上方曲目的區域。點擊區域可選取它（Delete 刪除）。重疊處較小的區域優先。",
      "none": "還沒有音樂區域。",
      "areaN": "區域 {num}",
      "selectArea": "在世界中選取此區域（方框會高亮；按 Delete 刪除）",
      "removeArea": "移除此音樂區域",
      "areaCap": "音樂區域已達上限（{max}）。",
      "track": {
        "town_eastbrook": "城鎮：東溪（溫暖田園）",
        "town_fenbridge": "城鎮：芬橋（古典中世紀）",
        "town_highwatch": "城鎮：高望（輕快進行曲）",
        "vale": "溪谷（歡快草甸）",
        "vale_legacy": "溪谷懷舊（原版主題）",
        "marsh": "沼澤（蛙鳴濕地）",
        "peaks": "山峰（英雄民謠）",
        "dungeon_hollow_crypt": "地下城：空幽墓穴（骸骨之舞）",
        "dungeon_sunken_bastion": "地下城：沉沒堡壘（水淹要塞）",
        "dungeon_gravewyrm_sanctum": "地下城：墓龍聖殿（首領之路）"
      }
    },
    "weather": {
      "title": "天氣",
      ...
      "cloudCover": "雲量",
      "cloudHeight": "雲層高度（碼）",
      "cloudHint": "低空雲會貼著地形，呈現為滾動的地面霧。",
      "scheduleTitle": "動態天氣",
      "scheduleWins": "排程正在執行：它會覆蓋上面的固定天氣。",
      "stepMode": "此階段的天氣",
      "stepMinutes": "此階段持續的分鐘數",
      "minutesShort": "分鐘",
      "removeStep": "移除此階段",
      "addStep": "新增階段",
      "addStepTitle": "按順序循環各階段，每個階段持續其設定的分鐘數，然後重複",
      "scheduleHint": "階段按順序循環（雨 5 分鐘，然後晴 10 分鐘，...）。隨地圖保存並在試玩中執行。"
    },
    "camera": {
      "title": "相機",
      "focus": "聚焦選取項（.）",
      "focusTitle": "把環繞軸心移到選取物體上，使相機圍繞它旋轉；未選取時框選整張地圖",
      "freeFly": "自由飛行（Shift+F）",
      "freeFlyHint": "WASD 移動，Q/E 升降，拖動如第一人稱環視。",
      "invertPan": "反轉平移",
    ...
    "help": {
      ...
      "tool": {
        ...
        "move": "用三軸座標器箭頭移動選取的資產。",
        "rotate": "用座標環旋轉選取的資產。",
        "scale": "用座標手柄按軸或整體縮放選取的資產。",
        "raise": "抬高筆刷下方的地形。",
        "lower": "降低筆刷下方的地形。",
        "smooth": "將起伏平滑到局部平均高度。",
        ...
        "foliage": "以可變尺寸筆刷繪製草、灌木、樹木和岩石。",
        "blocker": "拖曳繪製在試玩中阻擋移動的隱形牆。",
        "collider": "放置盒形、球形或地板平面碰撞體積，試玩時不可見。",
      ...
      "key": {
        ...
        "multiSelect": "Shift+點擊可將資產加入或移出選取集（Blender 風格）。",
