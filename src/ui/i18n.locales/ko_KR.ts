...
export const ko_KR: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.flatMapName': '평평한 세계',
  'editor.topbar.newFlatTitle': '원하는 크기의 빈 평면 맵을 새로 만들기',
  'editor.topbar.importModel': '모델 가져오기',
  'editor.topbar.importModelTitle': '이 컴퓨터에서 .glb 또는 .gltf 모델을 불러와 배치합니다. 완전 오프라인(세션 동안 유지)',
  'editor.topbar.moreTitle': '추가 작업: 다른 이름으로 저장, 자동 저장, 포크, 가져오기/내보내기, 업로드',
  'editor.tool.rotate': '회전',
  'editor.tool.scale': '크기 조절',
  'editor.tool.foliage': '식생 브러시',
  'editor.tool.collider': '콜라이더',
  'editor.inspector.toolTab': '도구',
  'editor.inspector.lightingTab': '조명',
  'editor.biome.swatchColor': '새 견본 색상',
  'editor.biome.swatchNamePlaceholder': '견본 이름(선택)',
  'editor.biome.customHint': '사용자 지정 견본은 지면 색상만 바꾸며(지형 형태는 구역 생물군계 유지) 맵과 함께 저장됩니다.',
  'editor.biome.customFull': '견본 한도({max})에 도달했습니다.',
  'editor.biome.importTexture': '텍스처 견본 가져오기',
  'editor.biome.importTextureTitle': '이미지를 선택하면 새 견본으로 칠할 때 지면에 타일링됩니다(이 브라우저에 저장되며 다른 기기에서는 평균 색상으로 표시)',
  'editor.biome.importTextureFailed': '해당 이미지를 읽을 수 없습니다.',
  'editor.collider.title': '충돌 볼륨',
  'editor.collider.hint': '모양을 선택한 뒤 지면을 클릭해 배치합니다. 이동, 회전, 크기 조절(또는 아래 슬라이더)로 모양을 다듬으세요.',
  'editor.collider.shapeLabel': '콜라이더 모양',
  'editor.collider.box': '상자 콜라이더',
  'editor.collider.sphere': '구 콜라이더',
  'editor.collider.plane': '바닥 평면',
  'editor.collider.width': '너비',
  'editor.collider.height': '높이',
  'editor.collider.depth': '깊이',
  'editor.collider.diameter': '지름',
  'editor.collider.floorOffset': '바닥 높이 오프셋',
  'editor.collider.sizeHint': '치수는 크기 1 기준 야드이며, 크기 조절 도구가 배율을 곱합니다.',
  'editor.collider.playtestNote': '볼륨은 편집기에서 녹색으로 표시되고 플레이테스트에서는 보이지 않습니다. 상자와 구는 이동을 막고 바닥 평면은 걷는 지면을 높입니다.',
  'editor.foliageTool.title': '식생 브러시',
  'editor.foliageTool.hint': '지면을 드래그하면 브러시 안에 활성화된 식생이 흩뿌려집니다. 한 획이 실행 취소 한 단계입니다. 지우개로 개별 제거하세요.',
  'editor.foliageTool.density': '밀도',
  'editor.foliageTool.minScale': '최소 크기',
  'editor.foliageTool.maxScale': '최대 크기',
  'editor.foliageTool.grass': '풀과 고사리',
  'editor.foliageTool.bushes': '덤불',
  'editor.foliageTool.trees': '나무',
  'editor.foliageTool.rocks': '바위',
  'editor.foliageTool.collide': '새 식생이 이동을 막음',
  'editor.foliageTool.noneSelected': '칠하려면 최소 한 개의 식생 그룹을 켜세요.',
  'editor.selection.multiCount': '{count}개 애셋 선택됨',
  'editor.selection.multiHint': '이동, Shift+D 복제, 삭제는 선택 전체에 적용됩니다. Shift+클릭으로 애셋을 추가하거나 제거하세요.',
  'editor.transform.moveHint': '기즈모 화살표를 끌면 해당 축으로, 노란 사각형을 끌면 자유롭게 이동합니다. 화살표 키로 미세 조정.',
  'editor.transform.rotateHint': '기즈모 링을 끌어 해당 축으로 회전합니다. Shift+스크롤은 15도 단위 회전.',
  'editor.transform.scaleHint': '축 핸들을 끌면 해당 축이 늘어나고, 노란 중앙 큐브는 균등 크기 조절입니다.',
  'editor.transform.pickHint': '애셋을 클릭하면 선택되고 기즈모가 표시됩니다.',
  'editor.assets.importedTab': '가져옴',
  'editor.assets.importedEmpty': '이 세션에서 가져온 모델이 없습니다. 「모델 가져오기」로 .glb 또는 .gltf를 불러오세요.',
  'editor.assets.removeImported': '가져온 모델 제거(이 세션만)',
  'editor.importModel.notModel': '.glb 또는 .gltf 파일을 선택하세요.',
  'editor.importModel.tooLarge': '해당 파일이 64 MiB 가져오기 한도를 초과합니다.',
  'editor.importModel.imported': '「{name}」을(를) 가져왔습니다. 이 세션 동안만 유지되며 새로고침 후에는 다시 가져와야 합니다.',
  'editor.importModel.failed': '해당 모델 파일을 읽을 수 없습니다.',
  'editor.status.newFlatMap': '빈 맵을 시작했습니다.',
  'editor.newMap.hint': '프리셋을 고르거나 야드 단위로 크기를 정하세요. 맵은 경계가 있어 지형 능선과 보이지 않는 외곽 차단벽이 플레이테스트를 안쪽에 가둡니다.',
  'editor.newMap.width': '너비(야드)',
  'editor.newMap.height': '높이(야드)',
  'editor.newMap.scale': '배율',
  'editor.newMap.interior': '실내(60 x 60)',
  'editor.newMap.openWorld': '오픈 월드(400 x 800)',
  'editor.newMap.create': '만들기',
  'editor.lighting.title': '조명',
  'editor.lighting.presetLabel': '조명 프리셋',
  'editor.lighting.overcast': '흐림',
  'editor.lighting.night': '밤',
  'editor.lighting.customHint': '사용자 지정 조명(프리셋에서 수정됨).',
  'editor.lighting.sun': '태양광 강도',
  'editor.lighting.ambient': '주변광 강도',
  'editor.lighting.environment': '하늘 환경광',
  'editor.lighting.azimuth': '태양 방향',
  'editor.lighting.elevation': '태양 고도',
  'editor.lighting.sunColor': '태양광 색상',
  'editor.lighting.skyColor': '하늘 색조',
  'editor.lighting.hint': '편집기 미리보기 전용: 플레이테스트는 표준 게임 조명을 유지합니다.',
  'editor.camera.title': '카메라',
  'editor.camera.focus': '선택 항목 초점(.)',
  'editor.camera.focusTitle': '궤도 중심을 선택한 물체로 옮겨 카메라가 그 주위를 돌게 합니다. 선택이 없으면 맵 전체를 프레이밍',
  'editor.camera.freeFly': '자유 비행(Shift+F)',
  'editor.camera.freeFlyHint': 'WASD로 이동, Q/E로 상승/하강, 드래그하면 1인칭처럼 둘러봅니다.',
  'editor.camera.invertPan': '팬 반전',
  'editor.camera.showPlayer': '플레이테스트 캐릭터 표시',
  'editor.help.tool.move': '3축 기즈모 화살표로 선택한 애셋을 이동합니다.',
  'editor.help.tool.rotate': '기즈모 링으로 선택한 애셋을 회전합니다.',
  'editor.help.tool.scale': '기즈모 핸들로 축별 또는 균등하게 크기를 조절합니다.',
  'editor.help.tool.foliage': '크기 변화를 주며 풀, 덤불, 나무, 바위를 브러시로 칠합니다.',
  'editor.help.tool.collider': '상자, 구, 바닥 평면 충돌 볼륨을 배치합니다. 플레이테스트에서는 보이지 않습니다.',
  'editor.help.key.multiSelect': 'Shift+클릭으로 애셋을 선택에 추가하거나 제거합니다(블렌더 방식).',
  'editor.biome.tileSize': '텍스처 타일 크기(야드)',
  'editor.assets.resizeHandle': '드래그하여 에셋 브라우저 크기 조절',
  'editor.lightTool.lightN': '조명 {num}',
  'editor.lightTool.selectTitle': '월드에서 이 조명을 선택합니다(전구 배지가 커지고, Delete 키로 제거)',
  'editor.biome.pickTexture': '칠할 텍스처 선택',
  'editor.biome.alphaTitle': '브러시 알파',
  'editor.biome.alphaNone': '없음',
  'editor.biome.alphaImport': '알파 가져오기',
  'editor.biome.alphaImportTitle':
    '회색조 이미지를 브러시 마스크로 불러옵니다. 흰색은 칠하고 검은색은 가립니다(이 브라우저에 저장).',
  'editor.biome.alphaImportFailed': '해당 이미지를 브러시 알파로 읽지 못했습니다.',
  'editor.biome.alphaRemove': '가져온 이 알파 제거',
  'editor.biome.autoTitle': '자동 텍스처',
  'editor.biome.autoSlopeRock': '가파른 경사면의 바위',
  'editor.biome.autoSnowCaps': '눈 덮인 봉우리',
  'editor.biome.autoRim': '맵 가장자리의 산맥',
  'editor.biome.autoHint':
    '자동 텍스처 규칙입니다. 직접 칠한 부분이 항상 우선하며, 체크를 해제하면 맵 전체에서 그 규칙이 사라집니다.',
  'editor.appearance.fire': '불꽃 효과(움직이는 불길)',
  'editor.tool.music': '음악',
  'editor.weather.title': '날씨',
  'editor.weather.auto': '자동',
  'editor.weather.clear': '맑음',
  'editor.weather.rain': '비',
  'editor.weather.snow': '눈',
  'editor.weather.sparkle': '금빛 반짝임',
  'editor.weather.intensity': '강도',
  'editor.weather.cloudCover': '구름 양',
  'editor.weather.cloudHeight': '구름 높이(야드)',
  'editor.weather.cloudHint': '낮은 구름은 지형을 따라 흐르는 지면 안개처럼 보입니다.',
  'editor.weather.scheduleTitle': '동적 날씨',
  'editor.weather.scheduleWins': '스케줄이 실행 중입니다. 위의 고정 날씨보다 우선합니다.',
  'editor.weather.stepMode': '이 단계의 날씨',
  'editor.weather.stepMinutes': '이 단계의 지속 시간(분)',
  'editor.weather.minutesShort': '분',
  'editor.weather.removeStep': '이 단계 제거',
  'editor.weather.addStep': '단계 추가',
  'editor.weather.addStepTitle': '단계를 순서대로 반복합니다. 각 단계는 설정한 분만큼 지속됩니다',
  'editor.weather.scheduleHint':
    '단계는 순서대로 반복됩니다(비 5분, 맑음 10분, ...). 맵과 함께 저장되며 플레이테스트에서도 작동합니다.',
  'editor.music.title': '음악',
  'editor.music.hint':
    '맵 전체의 사운드트랙을 고르거나, 상자를 드래그해 구역마다 다른 곡을 지정하세요. 플레이테스트에서 경계를 넘으면 곡이 바뀝니다.',
  'editor.music.zoneTrack': '맵 트랙',
  'editor.music.default': '자동(생태 테마)',
  'editor.music.areasTitle': '음악 구역',
  'editor.music.areaTrack': '새 구역의 트랙',
  'editor.music.rowTrack': '이 구역의 트랙',
  'editor.music.dragHint':
    '땅에 상자를 드래그하면 위 트랙을 쓰는 구역이 추가됩니다. 구역을 클릭하면 선택됩니다(Delete 키로 제거). 겹치면 더 작은 구역이 우선합니다.',
  'editor.music.selectArea': '월드에서 이 구역을 선택합니다(상자가 강조되고, Delete 키로 제거)',
  'editor.music.none': '아직 음악 구역이 없습니다.',
  'editor.music.areaN': '구역 {num}',
  'editor.music.removeArea': '이 음악 구역 제거',
  'editor.music.areaCap': '음악 구역 한도에 도달했습니다({max}).',
  'editor.music.track.town_eastbrook': '마을: 이스트브룩(따뜻한 전원)',
  'editor.music.track.town_fenbridge': '마을: 펜브리지(고풍스러운 중세)',
  'editor.music.track.town_highwatch': '마을: 하이워치(경쾌한 행진곡)',
  'editor.music.track.vale': '계곡(명랑한 초원)',
  'editor.music.track.vale_legacy': '계곡 레거시(오리지널 테마)',
  'editor.music.track.marsh': '늪지(개구리 우는 습지)',
  'editor.music.track.peaks': '봉우리(영웅적인 포크)',
  'editor.music.track.dungeon_hollow_crypt': '던전: 공허한 지하묘지(해골의 춤)',
  'editor.music.track.dungeon_sunken_bastion': '던전: 가라앉은 요새(물에 잠긴 성채)',
  'editor.music.track.dungeon_gravewyrm_sanctum': '던전: 묘룡의 성소(보스 루트)',
  'editor.water.waterfallTitle': '폭포',
  'editor.water.placeWaterfall': '폭포 배치',
  'editor.water.placeWaterfallTitle': '배치 도구에 움직이는 폭포를 장착합니다(절벽을 클릭해 설치)',
  'editor.water.waterfallLabel': '폭포',
  'editor.water.waterfallHint':
    '거품 웅덩이가 있는 움직이는 물줄기입니다. S 키나 기즈모로 절벽에 맞게 키우고, Y 스케일 핸들로 높이만 늘릴 수 있습니다.',
};
