...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  'guide.worldPage.valePlaceNotes':
    'Eastbrook 是你的第一個主據點。Wolf Run 與 Boar Meadow 是溫和的狩獵場；Mirror Lake 是適合垂釣的靜謐水域；Webwood 與 Copper Dig 藏著蜘蛛與貪礦的掘地者；一座 Bandit Camp 與 Fallen Chapel 另有更粗野的活計；Reliquary Hill 向下通往 Collapsed Reliquary，這個王國的第一座探窟；而 Brightwood Glade 則是北方一片靜謐、陽光灑落的林地。',
  ...
  'hudChrome.auraEffect.imbueRange': '武器附魔：制裁時造成 {min} 到 {max} 點額外傷害',
  'hudChrome.auraEffect.stealth': '隱蔽；移動速度降低 {pct}%',
  'hudChrome.auraEffect.formBear': '熊形態：生命值與護甲提高',
  'hudChrome.auraEffect.formCat': '貓形態：近戰傷害與能量',
  'hudChrome.auraEffect.formTravel': '旅行形態：移動速度提高 {pct}%',
  'hudChrome.auraEffect.defensiveStance': '防禦姿態：受到的傷害降低，威脅值提高',
  'hudChrome.auraEffect.righteousFury': '正義之怒：神聖傷害產生的威脅值大幅提高',
  ...
  'editor.flatMapName': '平坦世界',
  'editor.topbar.newFlatTitle': '新建一張自選尺寸的空白平坦地圖',
  'editor.topbar.importModel': '匯入模型',
  'editor.topbar.importModelTitle': '從本機載入 .glb 或 .gltf 模型並放置，完全離線（保留於本工作階段）',
  'editor.topbar.moreTitle': '更多操作：另存為、自動儲存、分支、匯入/匯出、上傳',
  'editor.tool.rotate': '旋轉',
  'editor.tool.scale': '縮放',
  'editor.tool.foliage': '植被筆刷',
  'editor.tool.collider': '碰撞體',
  'editor.inspector.toolTab': '工具',
  'editor.inspector.lightingTab': '光照',
  'editor.biome.swatchColor': '新色板顏色',
  'editor.biome.swatchNamePlaceholder': '色板名稱（可選）',
  'editor.biome.customHint': '自訂色板只改變地面顏色（地形形狀維持區域生態群系），並隨地圖一起儲存。',
  'editor.biome.customFull': '已達到色板上限（{max}）。',
  'editor.biome.importTexture': '匯入紋理色板',
  'editor.biome.importTextureTitle': '選擇一張圖片：用新色板繪製時會將它平鋪在地面上（保存於此瀏覽器；其他機器顯示其平均顏色）',
  'editor.biome.importTextureFailed': '無法讀取該圖片。',
  'editor.collider.title': '碰撞體積',
  'editor.collider.hint': '選擇形狀後點擊地面放置。使用移動、旋轉和縮放（或下方滑桿）來調整它。',
  'editor.collider.shapeLabel': '碰撞體形狀',
  'editor.collider.box': '盒形碰撞體',
  'editor.collider.sphere': '球形碰撞體',
  'editor.collider.plane': '地板平面',
  'editor.collider.width': '寬度',
  'editor.collider.height': '高度',
  'editor.collider.depth': '深度',
  'editor.collider.diameter': '直徑',
  'editor.collider.floorOffset': '地板高度偏移',
  'editor.collider.sizeHint': '尺寸為縮放 1 時的碼數；縮放工具會按倍數放大。',
  'editor.collider.playtestNote': '體積在編輯器中顯示為綠色，試玩時不可見：盒體和球體阻擋移動，地板平面抬高可行走地面。',
  'editor.foliageTool.title': '植被筆刷',
  'editor.foliageTool.hint': '在地面上拖動即可在筆刷範圍內散布啟用的植被；每次筆畫為一步復原。用擦除移除單株。',
  'editor.foliageTool.density': '密度',
  'editor.foliageTool.minScale': '最小尺寸',
  'editor.foliageTool.maxScale': '最大尺寸',
  'editor.foliageTool.grass': '草與蕨類',
  'editor.foliageTool.bushes': '灌木',
  'editor.foliageTool.trees': '樹木',
  'editor.foliageTool.rocks': '岩石',
  'editor.foliageTool.collide': '新植被阻擋移動',
  'editor.foliageTool.noneSelected': '請至少啟用一組植被再繪製。',
  'editor.selection.multiCount': '已選取 {count} 個資產',
  'editor.selection.multiHint': '移動、Shift+D 複製和刪除會作用於整個選取集；Shift+點擊可增刪資產。',
  'editor.transform.moveHint': '拖動座標軸箭頭沿該軸移動，或拖動黃色方塊自由移動。方向鍵微調。',
  'editor.transform.rotateHint': '拖動座標環繞該軸旋轉。Shift+滾輪以 15 度步進旋轉。',
  'editor.transform.scaleHint': '拖動軸向手柄拉伸該軸，或拖動黃色中心立方體整體縮放。',
  'editor.transform.pickHint': '點擊資產以選取；座標器會出現在選取項上。',
  'editor.assets.importedTab': '已匯入',
  'editor.assets.importedEmpty': '本工作階段尚未匯入模型。使用「匯入模型」從本機載入 .glb 或 .gltf。',
  'editor.assets.removeImported': '移除已匯入的模型（僅本工作階段）',
  'editor.importModel.notModel': '請選擇 .glb 或 .gltf 檔案。',
  'editor.importModel.tooLarge': '該檔案超過 64 MiB 匯入上限。',
  'editor.importModel.imported': '已匯入「{name}」。僅保留於本工作階段；重新整理後需重新匯入。',
  'editor.importModel.failed': '無法讀取該模型檔案。',
  'editor.status.newFlatMap': '已建立空白地圖。',
  'editor.newMap.hint': '選擇預設或按碼數設定尺寸。地圖有邊界：地形山脊和隱形邊界牆會把試玩限制在內部。',
  'editor.newMap.width': '寬度（碼）',
  'editor.newMap.height': '高度（碼）',
  'editor.newMap.scale': '縮放倍數',
  'editor.newMap.interior': '室內（60 x 60）',
  'editor.newMap.openWorld': '開放世界（400 x 800）',
  'editor.newMap.create': '建立',
  'editor.lighting.title': '光照',
  'editor.lighting.presetLabel': '光照預設',
  'editor.lighting.overcast': '陰天',
  'editor.lighting.night': '夜晚',
  'editor.lighting.customHint': '自訂光照（基於預設修改）。',
  'editor.lighting.sun': '日光強度',
  'editor.lighting.ambient': '環境光強度',
  'editor.lighting.environment': '天空環境光',
  'editor.lighting.azimuth': '太陽方向',
  'editor.lighting.elevation': '太陽高度',
  'editor.lighting.sunColor': '日光顏色',
  'editor.lighting.skyColor': '天空色調',
  'editor.lighting.hint': '僅編輯器預覽：試玩保持標準遊戲光照。',
  'editor.camera.title': '相機',
  'editor.camera.focus': '聚焦選取項（.）',
  'editor.camera.focusTitle': '把環繞軸心移到選取物體上，使相機圍繞它旋轉；未選取時框選整張地圖',
  'editor.camera.freeFly': '自由飛行（Shift+F）',
  'editor.camera.freeFlyHint': 'WASD 移動，Q/E 升降，拖動如第一人稱環視。',
  'editor.camera.invertPan': '反轉平移',
  'editor.camera.showPlayer': '顯示試玩角色',
  'editor.help.tool.move': '用三軸座標器箭頭移動選取的資產。',
  'editor.help.tool.rotate': '用座標環旋轉選取的資產。',
  'editor.help.tool.scale': '用座標手柄按軸或整體縮放選取的資產。',
  'editor.help.tool.foliage': '以可變尺寸筆刷繪製草、灌木、樹木和岩石。',
  'editor.help.tool.collider': '放置盒形、球形或地板平面碰撞體積，試玩時不可見。',
  'editor.help.key.multiSelect': 'Shift+點擊可將資產加入或移出選取集（Blender 風格）。',
  'editor.biome.tileSize': '紋理平鋪尺寸（碼）',
  'editor.assets.resizeHandle': '拖動以調整資產瀏覽器大小',
  'editor.lightTool.lightN': '燈光 {num}',
  'editor.lightTool.selectTitle': '在世界中選取此燈光（燈泡圖示會放大；按 Delete 刪除）',
  'editor.biome.pickTexture': '選擇要繪製的紋理',
  'editor.biome.alphaTitle': '筆刷 Alpha',
  'editor.biome.alphaNone': '無',
  'editor.biome.alphaImport': '匯入 Alpha',
  'editor.biome.alphaImportTitle': '載入灰階圖片作為筆刷遮罩：白色繪製，黑色遮擋（保存在此瀏覽器中）',
  'editor.biome.alphaImportFailed': '無法將該圖片讀取為筆刷 Alpha。',
  'editor.biome.alphaRemove': '移除此匯入的 Alpha',
  'editor.biome.autoTitle': '自動紋理',
  'editor.biome.autoSlopeRock': '陡坡岩石',
  'editor.biome.autoSnowCaps': '雪頂山峰',
  'editor.biome.autoRim': '地圖邊緣山脈',
  'editor.biome.autoHint': '自動紋理規則。你的繪製始終優先於它們，取消勾選即在全圖移除該規則。',
  'editor.appearance.fire': '火焰效果（動態火苗）',
  'editor.tool.music': '音樂',
  'editor.weather.title': '天氣',
  'editor.weather.auto': '自動',
  'editor.weather.clear': '晴朗',
  'editor.weather.rain': '雨',
  'editor.weather.snow': '雪',
  'editor.weather.sparkle': '金色閃光',
  'editor.weather.intensity': '強度',
  'editor.weather.cloudCover': '雲量',
  'editor.weather.cloudHeight': '雲層高度（碼）',
  'editor.weather.cloudHint': '低空雲會貼著地形，呈現為滾動的地面霧。',
  'editor.weather.scheduleTitle': '動態天氣',
  'editor.weather.scheduleWins': '排程正在執行：它會覆蓋上面的固定天氣。',
  'editor.weather.stepMode': '此階段的天氣',
  'editor.weather.stepMinutes': '此階段持續的分鐘數',
  'editor.weather.minutesShort': '分鐘',
  'editor.weather.removeStep': '移除此階段',
  'editor.weather.addStep': '新增階段',
  'editor.weather.addStepTitle': '按順序循環各階段，每個階段持續其設定的分鐘數，然後重複',
  'editor.weather.scheduleHint': '階段按順序循環（雨 5 分鐘，然後晴 10 分鐘，...）。隨地圖保存並在試玩中執行。',
  'editor.music.title': '音樂',
  'editor.music.hint': '為整張地圖選擇配樂，或拖出方框讓區域擁有自己的曲目。試玩時跨越邊界會切換。',
  'editor.music.zoneTrack': '地圖曲目',
  'editor.music.default': '自動（生態主題）',
  'editor.music.areasTitle': '音樂區域',
  'editor.music.areaTrack': '新區域的曲目',
  'editor.music.rowTrack': '此區域的曲目',
  'editor.music.dragHint':
    '在地面拖出方框即可新增使用上方曲目的區域。點擊區域可選取它（Delete 刪除）。重疊處較小的區域優先。',
  'editor.music.selectArea': '在世界中選取此區域（方框會高亮；按 Delete 刪除）',
  'editor.music.none': '還沒有音樂區域。',
  'editor.music.areaN': '區域 {num}',
  'editor.music.removeArea': '移除此音樂區域',
  'editor.music.areaCap': '音樂區域已達上限（{max}）。',
  'editor.music.track.town_eastbrook': '城鎮：東溪（溫暖田園）',
  'editor.music.track.town_fenbridge': '城鎮：芬橋（古典中世紀）',
  'editor.music.track.town_highwatch': '城鎮：高望（輕快進行曲）',
  'editor.music.track.vale': '溪谷（歡快草甸）',
  'editor.music.track.vale_legacy': '溪谷懷舊（原版主題）',
  'editor.music.track.marsh': '沼澤（蛙鳴濕地）',
  'editor.music.track.peaks': '山峰（英雄民謠）',
  'editor.music.track.dungeon_hollow_crypt': '地下城：空幽墓穴（骸骨之舞）',
  'editor.music.track.dungeon_sunken_bastion': '地下城：沉沒堡壘（水淹要塞）',
  'editor.music.track.dungeon_gravewyrm_sanctum': '地下城：墓龍聖殿（首領之路）',
  'editor.water.waterfallTitle': '瀑布',
  'editor.water.placeWaterfall': '放置瀑布',
  'editor.water.placeWaterfallTitle': '用動態瀑布裝配放置工具（點擊懸崖即可放下）',
  'editor.water.waterfallLabel': '瀑布',
  'editor.water.waterfallHint': '帶泡沫水潭的動態落水幕。用 S 或座標器沿懸崖放大；用 Y 縮放手柄只拉伸高度。',
};
