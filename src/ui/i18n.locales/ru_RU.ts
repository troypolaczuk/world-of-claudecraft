...
export const ru_RU: Partial<Record<TranslationKey, string>> = {
  ...
  // Map editor additions (transform gizmo, colliders, foliage brush,
  // lighting, camera, sized maps, model import).
  'editor.flatMapName': 'Плоский мир',
  'editor.topbar.newFlatTitle': 'Создать пустую плоскую карту выбранного размера',
  'editor.topbar.importModel': 'Импорт модели',
  'editor.topbar.importModelTitle': 'Загрузить модель .glb или .gltf с этого компьютера и разместить её, полностью офлайн (хранится в течение сессии)',
  'editor.topbar.moreTitle': 'Дополнительные действия: сохранить как, автосохранение, форк, импорт/экспорт, загрузка',
  'editor.tool.rotate': 'Поворот',
  'editor.tool.scale': 'Масштаб',
  'editor.tool.foliage': 'Кисть растительности',
  'editor.tool.collider': 'Коллайдер',
  'editor.inspector.toolTab': 'Инструменты',
  'editor.inspector.lightingTab': 'Освещение',
  'editor.biome.swatchColor': 'Цвет нового образца',
  'editor.biome.swatchNamePlaceholder': 'Название образца (необязательно)',
  'editor.biome.customHint': 'Пользовательские образцы меняют только цвет земли (форма рельефа остаётся от биома зоны) и сохраняются вместе с картой.',
  'editor.biome.customFull': 'Достигнут предел образцов ({max}).',
  'editor.biome.importTexture': 'Импорт текстуры-образца',
  'editor.biome.importTextureTitle': 'Выберите изображение: покраска новым образцом замостит его по земле (хранится в этом браузере; на других машинах виден средний цвет)',
  'editor.biome.importTextureFailed': 'Не удалось прочитать это изображение.',
  'editor.collider.title': 'Объёмы столкновений',
  'editor.collider.hint': 'Выберите форму и щёлкните по земле, чтобы разместить её. Используйте перемещение, поворот и масштаб (или ползунки ниже).',
  'editor.collider.shapeLabel': 'Форма коллайдера',
  'editor.collider.box': 'Коллайдер-куб',
  'editor.collider.sphere': 'Коллайдер-сфера',
  'editor.collider.plane': 'Плоскость пола',
  'editor.collider.width': 'Ширина',
  'editor.collider.height': 'Высота',
  'editor.collider.depth': 'Глубина',
  'editor.collider.diameter': 'Диаметр',
  'editor.collider.floorOffset': 'Смещение высоты пола',
  'editor.collider.sizeHint': 'Размеры указаны в ярдах при масштабе 1; инструмент масштаба умножает их.',
  'editor.collider.playtestNote': 'В редакторе объёмы показаны зелёным, в плейтесте невидимы: кубы и сферы блокируют движение, плоскости пола поднимают проходимую поверхность.',
  'editor.foliageTool.title': 'Кисть растительности',
  'editor.foliageTool.hint': 'Проведите по земле, чтобы рассыпать включённую растительность внутри кисти; каждый мазок — один шаг отмены. Удаляйте ластиком.',
  'editor.foliageTool.density': 'Плотность',
  'editor.foliageTool.minScale': 'Мин. размер',
  'editor.foliageTool.maxScale': 'Макс. размер',
  'editor.foliageTool.grass': 'Трава и папоротники',
  'editor.foliageTool.bushes': 'Кусты',
  'editor.foliageTool.trees': 'Деревья',
  'editor.foliageTool.rocks': 'Камни',
  'editor.foliageTool.collide': 'Новая растительность блокирует движение',
  'editor.foliageTool.noneSelected': 'Включите хотя бы одну группу растительности, чтобы рисовать.',
  'editor.selection.multiCount': 'Выбрано ассетов: {count}',
  'editor.selection.multiHint': 'Перемещение, дублирование Shift+D и удаление применяются ко всему выделению; Shift+щелчок добавляет или убирает ассеты.',
  'editor.transform.moveHint': 'Тяните стрелку гизмо для движения по оси или жёлтый квадрат для свободного перемещения. Стрелки клавиатуры дают точную подгонку.',
  'editor.transform.rotateHint': 'Тяните кольцо гизмо, чтобы вращать вокруг оси. Shift+прокрутка вращает шагами по 15 градусов.',
  'editor.transform.scaleHint': 'Тяните осевой манипулятор, чтобы растянуть ось, или жёлтый центральный куб для равномерного масштаба.',
  'editor.transform.pickHint': 'Щёлкните по ассету, чтобы выбрать его; на выделении появится гизмо.',
  'editor.assets.importedTab': 'Импортированные',
  'editor.assets.importedEmpty': 'В этой сессии нет импортированных моделей. Используйте «Импорт модели», чтобы загрузить .glb или .gltf.',
  'editor.assets.removeImported': 'Удалить импортированную модель (только эта сессия)',
  'editor.importModel.notModel': 'Выберите файл .glb или .gltf.',
  'editor.importModel.tooLarge': 'Файл превышает лимит импорта 64 МиБ.',
  'editor.importModel.imported': 'Импортировано «{name}». Хранится в течение сессии; после перезагрузки импортируйте заново.',
  'editor.importModel.failed': 'Не удалось прочитать файл модели.',
  'editor.status.newFlatMap': 'Создана пустая карта.',
  'editor.newMap.hint': 'Выберите пресет или задайте размер в ярдах. Карта ограничена: гребни рельефа и невидимые стены по периметру удерживают плейтест внутри.',
  'editor.newMap.width': 'Ширина (ярды)',
  'editor.newMap.height': 'Высота (ярды)',
  'editor.newMap.scale': 'Множитель масштаба',
  'editor.newMap.interior': 'Интерьер (60 x 60)',
  'editor.newMap.openWorld': 'Открытый мир (400 x 800)',
  'editor.newMap.create': 'Создать',
  'editor.lighting.title': 'Освещение',
  'editor.lighting.presetLabel': 'Пресет освещения',
  'editor.lighting.overcast': 'Пасмурно',
  'editor.lighting.night': 'Ночь',
  'editor.lighting.customHint': 'Пользовательское освещение (изменено из пресета).',
  'editor.lighting.sun': 'Интенсивность солнца',
  'editor.lighting.ambient': 'Интенсивность рассеянного света',
  'editor.lighting.environment': 'Свечение неба',
  'editor.lighting.azimuth': 'Направление солнца',
  'editor.lighting.elevation': 'Высота солнца',
  'editor.lighting.sunColor': 'Цвет солнца',
  'editor.lighting.skyColor': 'Оттенок неба',
  'editor.lighting.hint': 'Только предпросмотр в редакторе: в плейтесте остаётся стандартное игровое освещение.',
  'editor.camera.title': 'Камера',
  'editor.camera.focus': 'Фокус на выделении (.)',
  'editor.camera.focusTitle': 'Переносит центр орбиты на выбранный объект, чтобы камера вращалась вокруг него; без выделения кадрирует всю карту',
  'editor.camera.freeFly': 'Свободный полёт (Shift+F)',
  'editor.camera.freeFlyHint': 'WASD — движение, Q/E — вверх/вниз, перетаскивание — обзор от первого лица.',
  'editor.camera.invertPan': 'Инвертировать панорамирование',
  'editor.camera.showPlayer': 'Показывать персонажа плейтеста',
  'editor.help.tool.move': 'Перемещайте выбранный ассет стрелками трёхосевого гизмо.',
  'editor.help.tool.rotate': 'Вращайте выбранный ассет кольцами гизмо.',
  'editor.help.tool.scale': 'Масштабируйте выбранный ассет по осям или равномерно с помощью гизмо.',
  'editor.help.tool.foliage': 'Рисуйте кистью траву, кусты, деревья и камни с вариацией размера.',
  'editor.help.tool.collider': 'Размещайте кубы, сферы и плоскости пола: объёмы столкновений, невидимые в плейтесте.',
  'editor.help.key.multiSelect': 'Shift+щелчок добавляет или убирает ассеты из выделения (в стиле Blender).',
  'editor.biome.tileSize': 'Размер тайла текстуры (ярды)',
  'editor.assets.resizeHandle': 'Перетащите, чтобы изменить высоту браузера ассетов',
  'editor.lightTool.lightN': 'Свет {num}',
  'editor.lightTool.selectTitle':
    'Выбрать этот источник света в мире (значок лампочки увеличится; Delete удаляет)',
  'editor.biome.pickTexture': 'Выберите текстуру для рисования',
  'editor.biome.alphaTitle': 'Альфа кисти',
  'editor.biome.alphaNone': 'Нет',
  'editor.biome.alphaImport': 'Импорт альфы',
  'editor.biome.alphaImportTitle':
    'Загрузите чёрно-белое изображение как маску кисти: белое красит, чёрное маскирует (хранится в этом браузере)',
  'editor.biome.alphaImportFailed': 'Не удалось прочитать это изображение как альфу кисти.',
  'editor.biome.alphaRemove': 'Удалить эту импортированную альфу',
  'editor.biome.autoTitle': 'Автотекстуры',
  'editor.biome.autoSlopeRock': 'Камень на крутых склонах',
  'editor.biome.autoSnowCaps': 'Заснеженные вершины',
  'editor.biome.autoRim': 'Горы по краю карты',
  'editor.biome.autoHint':
    'Правила автоматического текстурирования. Ваша покраска всегда важнее них; снятая галочка убирает правило по всей карте.',
  'editor.appearance.fire': 'Эффект огня (живое пламя)',
  'editor.tool.music': 'Музыка',
  'editor.weather.title': 'Погода',
  'editor.weather.auto': 'Авто',
  'editor.weather.clear': 'Ясно',
  'editor.weather.rain': 'Дождь',
  'editor.weather.snow': 'Снег',
  'editor.weather.sparkle': 'Золотые искры',
  'editor.weather.intensity': 'Интенсивность',
  'editor.weather.cloudCover': 'Облачность',
  'editor.weather.cloudHeight': 'Высота облаков (ярды)',
  'editor.weather.cloudHint': 'Низкие облака стелются по рельефу и выглядят как наземный туман.',
  'editor.weather.scheduleTitle': 'Динамическая погода',
  'editor.weather.scheduleWins': 'Расписание работает: оно важнее фиксированной погоды выше.',
  'editor.weather.stepMode': 'Погода на этом шаге',
  'editor.weather.stepMinutes': 'Длительность шага в минутах',
  'editor.weather.minutesShort': 'мин',
  'editor.weather.removeStep': 'Удалить этот шаг',
  'editor.weather.addStep': 'Добавить шаг',
  'editor.weather.addStepTitle':
    'Шаги идут по кругу в заданном порядке, каждый длится свои минуты, затем цикл повторяется',
  'editor.weather.scheduleHint':
    'Шаги повторяются по порядку (дождь 5 мин, затем ясно 10 мин, ...). Сохраняется с картой и работает в плейтесте.',
  'editor.music.title': 'Музыка',
  'editor.music.hint':
    'Выберите саундтрек для всей карты или растяните рамки, чтобы дать областям свои треки. В плейтесте музыка сменится на границе.',
  'editor.music.zoneTrack': 'Трек карты',
  'editor.music.default': 'Авто (тема биома)',
  'editor.music.areasTitle': 'Музыкальные области',
  'editor.music.areaTrack': 'Трек для новых областей',
  'editor.music.rowTrack': 'Трек этой области',
  'editor.music.dragHint':
    'Растяните рамку по земле, чтобы добавить область с выбранным выше треком. Щелчок по области выбирает её (Delete удаляет). При пересечении побеждает меньшая область.',
  'editor.music.selectArea': 'Выбрать эту область в мире (рамка подсветится; Delete удаляет)',
  'editor.music.none': 'Музыкальных областей пока нет.',
  'editor.music.areaN': 'Область {num}',
  'editor.music.removeArea': 'Удалить эту музыкальную область',
  'editor.music.areaCap': 'Достигнут предел музыкальных областей ({max}).',
  'editor.music.track.town_eastbrook': 'Город: Истбрук (тёплая пастораль)',
  'editor.music.track.town_fenbridge': 'Город: Фенбридж (старое средневековье)',
  'editor.music.track.town_highwatch': 'Город: Хайвотч (бодрый марш)',
  'editor.music.track.vale': 'Долина (игривый луг)',
  'editor.music.track.vale_legacy': 'Долина, классика (оригинальная тема)',
  'editor.music.track.marsh': 'Болото (квакающая топь)',
  'editor.music.track.peaks': 'Пики (героический фолк)',
  'editor.music.track.dungeon_hollow_crypt': 'Подземелье: Полая крипта (танец скелетов)',
  'editor.music.track.dungeon_sunken_bastion': 'Подземелье: Затонувший бастион (залитая крепость)',
  'editor.music.track.dungeon_gravewyrm_sanctum': 'Подземелье: Святилище Могильного змея (путь к боссу)',
  'editor.water.waterfallTitle': 'Водопады',
  'editor.water.placeWaterfall': 'Разместить водопад',
  'editor.water.placeWaterfallTitle':
    'Зарядить инструмент размещения анимированным водопадом (щёлкните по обрыву, чтобы поставить)',
  'editor.water.waterfallLabel': 'Водопад',
  'editor.water.waterfallHint':
    'Анимированная стена падающей воды с пенным омутом. Масштабируйте по обрыву клавишей S или гизмо; ручка Y растягивает только высоту.',
};
