...
export const ja_JP: Partial<Record<TranslationKey, string>> = {
  ...
  'hudChrome.auraEffect.imbueRange': '武器付与: 裁きで{min}から{max}の追加ダメージ',
  'hudChrome.auraEffect.stealth': '隠密状態。移動速度が{pct}%低下する',
  'hudChrome.auraEffect.formBear': 'ベアフォーム: 体力と防御力が上昇',
  'hudChrome.auraEffect.formCat': 'キャットフォーム: 近接ダメージとエネルギー',
  'hudChrome.auraEffect.formTravel': 'トラベルフォーム: 移動速度が{pct}%上昇',
  'hudChrome.auraEffect.defensiveStance':
    'ディフェンシブスタンス: 受けるダメージが減少し、脅威度が上昇',
  'hudChrome.auraEffect.righteousFury': '正義の怒り: 神聖ダメージによる脅威度が大幅に上昇',
  ...
  'editor.flatMapName': 'フラットワールド',
  'editor.topbar.newFlatTitle': 'サイズを選べる空白のフラットマップを新規作成',
  'editor.topbar.importModel': 'モデルを読み込む',
  'editor.topbar.importModelTitle': 'この端末から .glb / .gltf モデルを読み込んで配置（完全オフライン、セッション中保持）',
  'editor.topbar.moreTitle': 'その他の操作：名前を付けて保存・自動保存・フォーク・インポート/エクスポート・アップロード',
  'editor.tool.rotate': '回転',
  'editor.tool.scale': 'スケール',
  'editor.tool.foliage': '植生ペイント',
  'editor.tool.collider': 'コライダー',
  'editor.inspector.toolTab': 'ツール',
  'editor.inspector.lightingTab': 'ライティング',
  'editor.biome.swatchColor': '新しいスウォッチの色',
  'editor.biome.swatchNamePlaceholder': 'スウォッチ名（任意）',
  'editor.biome.customHint': 'カスタムスウォッチは地面の色のみを変更し（地形形状はゾーンのバイオームのまま）、マップと共に保存されます。',
  'editor.biome.customFull': 'スウォッチの上限（{max}）に達しました。',
  'editor.biome.importTexture': 'テクスチャスウォッチを読み込む',
  'editor.biome.importTextureTitle': '画像を選ぶと、新しいスウォッチでのペイント時に地面へタイル状に敷き詰められます（このブラウザに保存され、他の端末では平均色が表示されます）',
  'editor.biome.importTextureFailed': 'その画像を読み込めませんでした。',
  'editor.collider.title': 'コリジョンボリューム',
  'editor.collider.hint': '形状を選んで地面をクリックすると配置されます。移動・回転・スケール（または下のスライダー）で形を整えます。',
  'editor.collider.shapeLabel': 'コライダーの形状',
  'editor.collider.box': 'ボックスコライダー',
  'editor.collider.sphere': 'スフィアコライダー',
  'editor.collider.plane': '床プレーン',
  'editor.collider.width': '幅',
  'editor.collider.height': '高さ',
  'editor.collider.depth': '奥行き',
  'editor.collider.diameter': '直径',
  'editor.collider.floorOffset': '床の高さオフセット',
  'editor.collider.sizeHint': '寸法はスケール1のヤード値です。スケールツールで倍率がかかります。',
  'editor.collider.playtestNote': 'ボリュームはエディタでは緑で表示され、プレイテストでは非表示です。ボックスとスフィアは移動を妨げ、床プレーンは歩行面を持ち上げます。',
  'editor.foliageTool.title': '植生ブラシ',
  'editor.foliageTool.hint': '地面をドラッグするとブラシ範囲内に有効な植生が散布されます。1ストロークが1回のアンドゥです。個別の削除は消しゴムで。',
  'editor.foliageTool.density': '密度',
  'editor.foliageTool.minScale': '最小サイズ',
  'editor.foliageTool.maxScale': '最大サイズ',
  'editor.foliageTool.grass': '草とシダ',
  'editor.foliageTool.bushes': '低木',
  'editor.foliageTool.trees': '木',
  'editor.foliageTool.rocks': '岩',
  'editor.foliageTool.collide': '新しい植生が移動を妨げる',
  'editor.foliageTool.noneSelected': 'ペイントするには少なくとも1つの植生グループを有効にしてください。',
  'editor.selection.multiCount': '{count} 個のアセットを選択中',
  'editor.selection.multiHint': '移動・Shift+D 複製・削除は選択全体に適用されます。Shift+クリックでアセットを追加/除外します。',
  'editor.transform.moveHint': 'ギズモの矢印でその軸に沿って移動、黄色い四角で自由移動。矢印キーで微調整。',
  'editor.transform.rotateHint': 'ギズモのリングをドラッグしてその軸で回転。Shift+スクロールで15度刻みの回転も可能。',
  'editor.transform.scaleHint': '軸ハンドルをドラッグでその軸を伸縮、中央の黄色いキューブで均等スケール。',
  'editor.transform.pickHint': 'アセットをクリックすると選択され、ギズモが表示されます。',
  'editor.assets.importedTab': 'インポート済み',
  'editor.assets.importedEmpty': 'このセッションで読み込んだモデルはありません。「モデルを読み込む」で .glb / .gltf を読み込めます。',
  'editor.assets.removeImported': 'インポートしたモデルを削除（このセッションのみ）',
  'editor.importModel.notModel': '.glb または .gltf ファイルを選んでください。',
  'editor.importModel.tooLarge': 'そのファイルは 64 MiB のインポート上限を超えています。',
  'editor.importModel.imported': '「{name}」を読み込みました。このセッション中のみ保持され、リロード後は再読み込みが必要です。',
  'editor.importModel.failed': 'そのモデルファイルを読み込めませんでした。',
  'editor.status.newFlatMap': '空白マップを開始しました。',
  'editor.newMap.hint': 'プリセットを選ぶかヤード単位でサイズを指定します。マップには境界があり、地形の縁と不可視の外周ブロッカーがプレイテストを内側に留めます。',
  'editor.newMap.width': '幅（ヤード）',
  'editor.newMap.height': '高さ（ヤード）',
  'editor.newMap.scale': 'スケール倍率',
  'editor.newMap.interior': '屋内（60 x 60）',
  'editor.newMap.openWorld': 'オープンワールド（400 x 800）',
  'editor.newMap.create': '作成',
  'editor.lighting.title': 'ライティング',
  'editor.lighting.presetLabel': 'ライティングプリセット',
  'editor.lighting.overcast': '曇り',
  'editor.lighting.night': '夜',
  'editor.lighting.customHint': 'カスタムライティング（プリセットから編集）。',
  'editor.lighting.sun': '太陽光の強さ',
  'editor.lighting.ambient': '環境光の強さ',
  'editor.lighting.environment': '空の環境光',
  'editor.lighting.azimuth': '太陽の方角',
  'editor.lighting.elevation': '太陽の高さ',
  'editor.lighting.sunColor': '太陽光の色',
  'editor.lighting.skyColor': '空の色合い',
  'editor.lighting.hint': 'エディタのプレビュー専用：プレイテストは標準のゲームライティングのままです。',
  'editor.camera.title': 'カメラ',
  'editor.camera.focus': '選択にフォーカス（.）',
  'editor.camera.focusTitle': '軌道の中心を選択オブジェクトに移し、カメラがその周りを回るようにします。未選択時はマップ全体をフレーミング',
  'editor.camera.freeFly': 'フリーフライト（Shift+F）',
  'editor.camera.freeFlyHint': 'WASD で移動、Q/E で上下、ドラッグで一人称視点のように見回します。',
  'editor.camera.invertPan': 'パン反転',
  'editor.camera.showPlayer': 'プレイテスト用プレイヤーを表示',
  'editor.help.tool.move': '3軸ギズモの矢印で選択アセットを移動します。',
  'editor.help.tool.rotate': 'ギズモのリングで選択アセットを回転します。',
  'editor.help.tool.scale': 'ギズモのハンドルで軸ごと、または均等にスケールします。',
  'editor.help.tool.foliage': 'サイズのばらつき付きで草・低木・木・岩をブラシペイントします。',
  'editor.help.tool.collider': 'ボックス・スフィア・床プレーンのコリジョンを配置します。プレイテストでは非表示。',
  'editor.help.key.multiSelect': 'Shift+クリックでアセットを選択に追加/除外します（Blender流）。',
  'editor.biome.tileSize': 'テクスチャのタイルサイズ（ヤード）',
  'editor.assets.resizeHandle': 'ドラッグでアセットブラウザーの高さを調整',
  'editor.lightTool.lightN': 'ライト {num}',
  'editor.lightTool.selectTitle': 'ワールド内でこのライトを選択（電球バッジが拡大。Delete で削除）',
  'editor.biome.pickTexture': 'ペイントするテクスチャを選択',
  'editor.biome.alphaTitle': 'ブラシアルファ',
  'editor.biome.alphaNone': 'なし',
  'editor.biome.alphaImport': 'アルファを読み込む',
  'editor.biome.alphaImportTitle':
    'グレースケール画像をブラシマスクとして読み込みます：白は塗り、黒はマスク（このブラウザーに保存）',
  'editor.biome.alphaImportFailed': 'その画像をブラシアルファとして読み込めませんでした。',
  'editor.biome.alphaRemove': 'この読み込んだアルファを削除',
  'editor.biome.autoTitle': '自動テクスチャ',
  'editor.biome.autoSlopeRock': '急斜面の岩肌',
  'editor.biome.autoSnowCaps': '冠雪した山頂',
  'editor.biome.autoRim': 'マップ端の山並み',
  'editor.biome.autoHint':
    '自動テクスチャのルールです。ペイントが常に優先され、チェックを外すとマップ全体からそのルールが外れます。',
  'editor.appearance.fire': '炎エフェクト（アニメーション付き）',
  'editor.tool.music': 'ミュージック',
  'editor.weather.title': '天候',
  'editor.weather.auto': '自動',
  'editor.weather.clear': '晴れ',
  'editor.weather.rain': '雨',
  'editor.weather.snow': '雪',
  'editor.weather.sparkle': '金色のきらめき',
  'editor.weather.intensity': '強さ',
  'editor.weather.cloudCover': '雲量',
  'editor.weather.cloudHeight': '雲の高さ（ヤード）',
  'editor.weather.cloudHint': '低い雲は地形に沿って流れる地表の霧として見えます。',
  'editor.weather.scheduleTitle': 'ダイナミック天候',
  'editor.weather.scheduleWins': 'スケジュール実行中：上の固定天候より優先されます。',
  'editor.weather.stepMode': 'このステップの天候',
  'editor.weather.stepMinutes': 'このステップの継続分数',
  'editor.weather.minutesShort': '分',
  'editor.weather.removeStep': 'このステップを削除',
  'editor.weather.addStep': 'ステップを追加',
  'editor.weather.addStepTitle': 'ステップを順番に繰り返します。各ステップは設定した分数だけ続きます',
  'editor.weather.scheduleHint':
    'ステップは順番にループします（雨 5 分、晴れ 10 分、...）。マップと一緒に保存され、プレイテストでも動きます。',
  'editor.music.title': 'ミュージック',
  'editor.music.hint':
    'マップ全体のサウンドトラックを選ぶか、ボックスをドラッグしてエリアごとの曲を設定します。プレイテストでは境界を越えると切り替わります。',
  'editor.music.zoneTrack': 'マップの曲',
  'editor.music.default': '自動（バイオームのテーマ）',
  'editor.music.areasTitle': 'ミュージックエリア',
  'editor.music.areaTrack': '新しいエリアの曲',
  'editor.music.rowTrack': 'このエリアの曲',
  'editor.music.dragHint':
    '地面にボックスをドラッグすると上の曲を使うエリアが追加されます。エリアをクリックすると選択できます（Delete で削除）。重なった場合は小さいエリアが優先。',
  'editor.music.selectArea': 'ワールド内でこのエリアを選択（ボックスがハイライト。Delete で削除）',
  'editor.music.none': 'ミュージックエリアはまだありません。',
  'editor.music.areaN': 'エリア {num}',
  'editor.music.removeArea': 'このミュージックエリアを削除',
  'editor.music.areaCap': 'ミュージックエリアの上限に達しました（{max}）。',
  'editor.music.track.town_eastbrook': '町：イーストブルック（暖かな田園）',
  'editor.music.track.town_fenbridge': '町：フェンブリッジ（古風な中世）',
  'editor.music.track.town_highwatch': '町：ハイウォッチ（軽快な行進曲）',
  'editor.music.track.vale': '渓谷（陽気な草原）',
  'editor.music.track.vale_legacy': '渓谷レガシー（オリジナルテーマ）',
  'editor.music.track.marsh': '湿地（蛙鳴く沼）',
  'editor.music.track.peaks': '山峰（勇壮なフォーク）',
  'editor.music.track.dungeon_hollow_crypt': 'ダンジョン：虚ろの地下聖堂（骸骨の舞）',
  'editor.music.track.dungeon_sunken_bastion': 'ダンジョン：沈んだ砦（水没要塞）',
  'editor.music.track.dungeon_gravewyrm_sanctum': 'ダンジョン：墓竜の聖域（ボスへの道）',
  'editor.water.waterfallTitle': '滝',
  'editor.water.placeWaterfall': '滝を配置',
  'editor.water.placeWaterfallTitle': '配置ツールにアニメーション付きの滝をセットします（崖をクリックで設置）',
  'editor.water.waterfallLabel': '滝',
  'editor.water.waterfallHint':
    '泡立つ滝つぼ付きのアニメーション水幕です。S かギズモで崖に合わせて拡大し、Y スケールで高さだけ伸ばせます。',
};
