...
export const zh_CN: Partial<Record<TranslationKey, string>> = {
  ...
  'editor.topbar.newFlatTitle': '新建一张自选尺寸的空白平坦地图',
  'editor.topbar.importModel': '导入模型',
  'editor.topbar.importModelTitle': '从本机加载 .glb 或 .gltf 模型并放置，完全离线（保留在本会话中）',
  'editor.topbar.moreTitle': '更多操作：另存为、自动保存、派生、导入/导出、上传',
  'editor.tool.rotate': '旋转',
  'editor.tool.scale': '缩放',
  'editor.tool.foliage': '植被笔刷',
  'editor.tool.collider': '碰撞体',
  'editor.inspector.toolTab': '工具',
  'editor.inspector.lightingTab': '光照',
  'editor.biome.swatchColor': '新色板颜色',
  'editor.biome.swatchNamePlaceholder': '色板名称（可选）',
  'editor.biome.customHint': '自定义色板只改变地面颜色（地形形状保持区域生态群系），并随地图一起保存。',
  'editor.biome.customFull': '已达到色板上限（{max}）。',
  'editor.biome.importTexture': '导入纹理色板',
  'editor.biome.importTextureTitle': '选择一张图片：用新色板绘制时会将它平铺在地面上（保存在此浏览器中；其他机器显示其平均颜色）',
  'editor.biome.importTextureFailed': '无法读取该图片。',
  'editor.collider.title': '碰撞体积',
  'editor.collider.hint': '选择形状后点击地面放置。使用移动、旋转和缩放（或下方滑块）来调整它。',
  'editor.collider.shapeLabel': '碰撞体形状',
  'editor.collider.box': '盒形碰撞体',
  'editor.collider.sphere': '球形碰撞体',
  'editor.collider.plane': '地板平面',
  'editor.collider.width': '宽度',
  'editor.collider.height': '高度',
  'editor.collider.depth': '深度',
  'editor.collider.diameter': '直径',
  'editor.collider.floorOffset': '地板高度偏移',
  'editor.collider.sizeHint': '尺寸为缩放 1 时的码数；缩放工具会按倍数放大。',
  'editor.collider.playtestNote': '体积在编辑器中显示为绿色，试玩时不可见：盒体和球体阻挡移动，地板平面抬高可行走地面。',
  'editor.foliageTool.title': '植被笔刷',
  'editor.foliageTool.hint': '在地面上拖动即可在笔刷范围内散布启用的植被；每次笔画为一步撤销。用擦除移除单株。',
  'editor.foliageTool.density': '密度',
  'editor.foliageTool.minScale': '最小尺寸',
  'editor.foliageTool.maxScale': '最大尺寸',
  'editor.foliageTool.grass': '草与蕨类',
  'editor.foliageTool.bushes': '灌木',
  'editor.foliageTool.trees': '树木',
  'editor.foliageTool.rocks': '岩石',
  'editor.foliageTool.collide': '新植被阻挡移动',
  'editor.foliageTool.noneSelected': '请至少启用一组植被再绘制。',
  'editor.selection.multiCount': '已选中 {count} 个资产',
  'editor.selection.multiHint': '移动、Shift+D 复制和删除会作用于整个选择集；Shift+点击可增删资产。',
  'editor.transform.moveHint': '拖动坐标轴箭头沿该轴移动，或拖动黄色方块自由移动。方向键微调。',
  'editor.transform.rotateHint': '拖动坐标环绕该轴旋转。Shift+滚轮以 15 度步进旋转。',
  'editor.transform.scaleHint': '拖动轴向手柄拉伸该轴，或拖动黄色中心立方体整体缩放。',
  'editor.transform.pickHint': '点击资产以选中；坐标器会出现在选中项上。',
  'editor.assets.importedTab': '已导入',
  'editor.assets.importedEmpty': '本会话尚未导入模型。使用「导入模型」从本机加载 .glb 或 .gltf。',
  'editor.assets.removeImported': '移除已导入的模型（仅本会话）',
  'editor.importModel.notModel': '请选择 .glb 或 .gltf 文件。',
  'editor.importModel.tooLarge': '该文件超过 64 MiB 导入上限。',
  'editor.importModel.imported': '已导入「{name}」。仅保留在本会话中；刷新后需重新导入。',
  'editor.importModel.failed': '无法读取该模型文件。',
  'editor.status.newFlatMap': '已创建空白地图。',
  'editor.newMap.hint': '选择预设或按码数设置尺寸。地图有边界：地形山脊和隐形边界墙会把试玩限制在内部。',
  'editor.newMap.width': '宽度（码）',
  'editor.newMap.height': '高度（码）',
  'editor.newMap.scale': '缩放倍数',
  'editor.newMap.interior': '室内（60 x 60）',
  'editor.newMap.openWorld': '开放世界（400 x 800）',
  'editor.newMap.create': '创建',
  'editor.lighting.title': '光照',
  'editor.lighting.presetLabel': '光照预设',
  'editor.lighting.overcast': '阴天',
  'editor.lighting.night': '夜晚',
  'editor.lighting.customHint': '自定义光照（基于预设修改）。',
  'editor.lighting.sun': '日光强度',
  'editor.lighting.ambient': '环境光强度',
  'editor.lighting.environment': '天空环境光',
  'editor.lighting.azimuth': '太阳方向',
  'editor.lighting.elevation': '太阳高度',
  'editor.lighting.sunColor': '日光颜色',
  'editor.lighting.skyColor': '天空色调',
  'editor.lighting.hint': '仅编辑器预览：试玩保持标准游戏光照。',
  'editor.camera.title': '相机',
  'editor.camera.focus': '聚焦选中项（.）',
  'editor.camera.focusTitle': '把环绕轴心移到选中物体上，使相机围绕它旋转；未选中时框选整张地图',
  'editor.camera.freeFly': '自由飞行（Shift+F）',
  'editor.camera.freeFlyHint': 'WASD 移动，Q/E 升降，拖动如第一人称环视。',
  'editor.camera.invertPan': '反转平移',
  'editor.camera.showPlayer': '显示试玩角色',
  'editor.help.tool.move': '用三轴坐标器箭头移动选中的资产。',
  'editor.help.tool.rotate': '用坐标环旋转选中的资产。',
  'editor.help.tool.scale': '用坐标手柄按轴或整体缩放选中的资产。',
  'editor.help.tool.foliage': '以可变尺寸笔刷绘制草、灌木、树木和岩石。',
  'editor.help.tool.collider': '放置盒形、球形或地板平面碰撞体积，试玩时不可见。',
  'editor.help.key.multiSelect': 'Shift+点击可将资产加入或移出选择集（Blender 风格）。',
  'editor.biome.tileSize': '纹理平铺尺寸（码）',
  'editor.assets.resizeHandle': '拖动以调整资产浏览器大小',
  'editor.lightTool.lightN': '灯光 {num}',
  'editor.lightTool.selectTitle': '在世界中选中此灯光（灯泡图标会放大；按 Delete 删除）',
  'editor.biome.pickTexture': '选择要绘制的纹理',
  'editor.biome.alphaTitle': '笔刷 Alpha',
  'editor.biome.alphaNone': '无',
  'editor.biome.alphaImport': '导入 Alpha',
  'editor.biome.alphaImportTitle': '加载灰度图片作为笔刷遮罩：白色绘制，黑色遮挡（保存在此浏览器中）',
  'editor.biome.alphaImportFailed': '无法将该图片读取为笔刷 Alpha。',
  'editor.biome.alphaRemove': '移除此导入的 Alpha',
  'editor.biome.autoTitle': '自动纹理',
  'editor.biome.autoSlopeRock': '陡坡岩石',
  'editor.biome.autoSnowCaps': '雪顶山峰',
  'editor.biome.autoRim': '地图边缘山脉',
  'editor.biome.autoHint': '自动纹理规则。你的绘制始终优先于它们，取消勾选即在全图移除该规则。',
  'editor.appearance.fire': '火焰效果（动态火苗）',
  'editor.tool.music': '音乐',
  'editor.weather.title': '天气',
  'editor.weather.auto': '自动',
  'editor.weather.clear': '晴朗',
  'editor.weather.rain': '雨',
  'editor.weather.snow': '雪',
  'editor.weather.sparkle': '金色闪光',
  'editor.weather.intensity': '强度',
  'editor.weather.cloudCover': '云量',
  'editor.weather.cloudHeight': '云层高度（码）',
  'editor.weather.cloudHint': '低空云会贴着地形，呈现为滚动的地面雾。',
  'editor.weather.scheduleTitle': '动态天气',
  'editor.weather.scheduleWins': '计划正在运行：它会覆盖上面的固定天气。',
  'editor.weather.stepMode': '此阶段的天气',
  'editor.weather.stepMinutes': '此阶段持续的分钟数',
  'editor.weather.minutesShort': '分钟',
  'editor.weather.removeStep': '移除此阶段',
  'editor.weather.addStep': '添加阶段',
  'editor.weather.addStepTitle': '按顺序循环各阶段，每个阶段持续其设定的分钟数，然后重复',
  'editor.weather.scheduleHint': '阶段按顺序循环（雨 5 分钟，然后晴 10 分钟，...）。随地图保存并在试玩中运行。',
  'editor.music.title': '音乐',
  'editor.music.hint': '为整张地图选择配乐，或拖出方框让区域拥有自己的曲目。试玩时跨越边界会切换。',
  'editor.music.zoneTrack': '地图曲目',
  'editor.music.default': '自动（生态主题）',
  'editor.music.areasTitle': '音乐区域',
  'editor.music.areaTrack': '新区域的曲目',
  'editor.music.rowTrack': '此区域的曲目',
  'editor.music.dragHint':
    '在地面拖出方框即可添加使用上方曲目的区域。点击区域可选中它（Delete 删除）。重叠处较小的区域优先。',
  'editor.music.selectArea': '在世界中选中此区域（方框会高亮；按 Delete 删除）',
  'editor.music.none': '还没有音乐区域。',
  'editor.music.areaN': '区域 {num}',
  'editor.music.removeArea': '移除此音乐区域',
  'editor.music.areaCap': '音乐区域已达上限（{max}）。',
  'editor.music.track.town_eastbrook': '城镇：东溪（温暖田园）',
  'editor.music.track.town_fenbridge': '城镇：芬桥（古典中世纪）',
  'editor.music.track.town_highwatch': '城镇：高望（轻快进行曲）',
  'editor.music.track.vale': '溪谷（欢快草甸）',
  'editor.music.track.vale_legacy': '溪谷怀旧（原版主题）',
  'editor.music.track.marsh': '沼泽（蛙鸣湿地）',
  'editor.music.track.peaks': '山峰（英雄民谣）',
  'editor.music.track.dungeon_hollow_crypt': '地下城：空幽墓穴（骸骨之舞）',
  'editor.music.track.dungeon_sunken_bastion': '地下城：沉没堡垒（水淹要塞）',
  'editor.music.track.dungeon_gravewyrm_sanctum': '地下城：墓龙圣殿（首领之路）',
  'editor.water.waterfallTitle': '瀑布',
  'editor.water.placeWaterfall': '放置瀑布',
  'editor.water.placeWaterfallTitle': '用动态瀑布装配放置工具（点击悬崖即可放下）',
  'editor.water.waterfallLabel': '瀑布',
  'editor.water.waterfallHint': '带泡沫水潭的动态落水幕。用 S 或坐标器沿悬崖放大；用 Y 缩放手柄只拉伸高度。',
};
